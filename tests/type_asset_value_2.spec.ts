...
import * as type_asset_value_2_address from './contracts/bindings/type_asset_value_2_address'
import * as type_asset_value_2_bls12_381_fr from './contracts/bindings/type_asset_value_2_bls12_381_fr'
import * as type_asset_value_2_bls12_381_g1 from './contracts/bindings/type_asset_value_2_bls12_381_g1'
import * as type_asset_value_2_bls12_381_g2 from './contracts/bindings/type_asset_value_2_bls12_381_g2'
import * as type_asset_value_2_bool from './contracts/bindings/type_asset_value_2_bool'
import * as type_asset_value_2_bytes from './contracts/bindings/type_asset_value_2_bytes'
import * as type_asset_value_2_chain_id from './contracts/bindings/type_asset_value_2_chain_id'
//import * as type_asset_value_2_chest from './contracts/bindings/type_asset_value_2_chest'
//import * as type_asset_value_2_chest_key from './contracts/bindings/type_asset_value_2_chest_key'
import * as type_asset_value_2_date from './contracts/bindings/type_asset_value_2_date'
import * as type_asset_value_2_duration from './contracts/bindings/type_asset_value_2_duration'
import * as type_asset_value_2_int from './contracts/bindings/type_asset_value_2_int'
import * as type_asset_value_2_key from './contracts/bindings/type_asset_value_2_key'
import * as type_asset_value_2_key_hash from './contracts/bindings/type_asset_value_2_key_hash'
import * as type_asset_value_2_nat from './contracts/bindings/type_asset_value_2_nat'
import * as type_asset_value_2_rational from './contracts/bindings/type_asset_value_2_rational'
//import * as type_asset_value_2_sapling_transaction from './contracts/bindings/type_asset_value_2_sapling_transaction'
import * as type_asset_value_2_signature from './contracts/bindings/type_asset_value_2_signature'
import * as type_asset_value_2_string from './contracts/bindings/type_asset_value_2_string'
import * as type_asset_value_2_tez from './contracts/bindings/type_asset_value_2_tez'
import * as type_asset_value_2_tx_rollup_l2_address from './contracts/bindings/type_asset_value_2_tx_rollup_l2_address'
import * as type_asset_value_2_unit from './contracts/bindings/type_asset_value_2_unit'
import * as type_asset_value_2_list_nat from './contracts/bindings/type_asset_value_2_list_nat'
import * as type_asset_value_2_list_string from './contracts/bindings/type_asset_value_2_list_string'
import * as type_asset_value_2_list_bool from './contracts/bindings/type_asset_value_2_list_bool'
import * as type_asset_value_2_map_nat_string from './contracts/bindings/type_asset_value_2_map_nat_string'
import * as type_asset_value_2_option_nat from './contracts/bindings/type_asset_value_2_option_nat'
import * as type_asset_value_2_option_string from './contracts/bindings/type_asset_value_2_option_string'
import * as type_asset_value_2_option_bool from './contracts/bindings/type_asset_value_2_option_bool'
import * as type_asset_value_2_or_nat_string from './contracts/bindings/type_asset_value_2_or_nat_string'
import * as type_asset_value_2_set_nat from './contracts/bindings/type_asset_value_2_set_nat'
import * as type_asset_value_2_set_string from './contracts/bindings/type_asset_value_2_set_string'
import * as type_asset_value_2_set_bool from './contracts/bindings/type_asset_value_2_set_bool'
import * as type_asset_value_2_tuple_nat_string from './contracts/bindings/type_asset_value_2_tuple_nat_string'
import * as type_asset_value_2_tuple_nat_string_bytes from './contracts/bindings/type_asset_value_2_tuple_nat_string_bytes'
import * as type_asset_value_2_tuple_nat_string_bytes_bool from './contracts/bindings/type_asset_value_2_tuple_nat_string_bytes_bool'
import * as type_asset_value_2_tuple_nat_string_bytes_rev from './contracts/bindings/type_asset_value_2_tuple_nat_string_bytes_rev'
import * as type_asset_value_2_tuple_nat_string_bytes_bool_rev from './contracts/bindings/type_asset_value_2_tuple_nat_string_bytes_bool_rev'
import * as type_asset_value_2_tuple_nat_string_bytes_bool_custom from './contracts/bindings/type_asset_value_2_tuple_nat_string_bytes_bool_custom'
import * as type_asset_value_2_enum_simple from './contracts/bindings/type_asset_value_2_enum_simple'
import * as type_asset_value_2_enum_param from './contracts/bindings/type_asset_value_2_enum_param'
import * as type_asset_value_2_record_1_field from './contracts/bindings/type_asset_value_2_record_1_field'
import * as type_asset_value_2_record_2_fields from './contracts/bindings/type_asset_value_2_record_2_fields'
import * as type_asset_value_2_record_3_fields from './contracts/bindings/type_asset_value_2_record_3_fields'
import * as type_asset_value_2_record_4_fields from './contracts/bindings/type_asset_value_2_record_4_fields'
import * as type_asset_value_2_record_4_fields_custom from './contracts/bindings/type_asset_value_2_record_4_fields_custom'
import * as type_asset_value_2_record_complex from './contracts/bindings/type_asset_value_2_record_complex'
...
describe('Type asset_value_2', () => {
  ...
  it('tx_rollup_l2_address', async () => {
    ...
    await type_asset_value_2_tx_rollup_l2_address.type_asset_value_2_tx_rollup_l2_address.deploy({ as: alice });
    await type_asset_value_2_tx_rollup_l2_address.type_asset_value_2_tx_rollup_l2_address.asset_put(v, { as: alice });
    const res = await type_asset_value_2_tx_rollup_l2_address.type_asset_value_2_tx_rollup_l2_address.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('enum_simple', async () => {
    const v : type_asset_value_2_enum_simple.e_enum = new type_asset_value_2_enum_simple.e_2();
  ...
  // enum_param
  it('enum_param', async () => {
    const v : type_asset_value_2_enum_param.e_enum = new type_asset_value_2_enum_param.e_2(new Nat(2));
    await type_asset_value_2_enum_param.type_asset_value_2_enum_param.deploy({ as: alice });
    await type_asset_value_2_enum_param.type_asset_value_2_enum_param.asset_put(v, { as: alice });
    const res = await type_asset_value_2_enum_param.type_asset_value_2_enum_param.get_my_asset();
    assert(1 == res.length && ((x : type_asset_value_2_enum_param.e_enum, y : type_asset_value_2_enum_param.e_enum) => {return x.toString() == y.toString()})(v, res[0][1].v), "Invalid Value")
  });
  ...
  it('record_2_fields', async () => {
    const v : type_asset_value_2_record_2_fields.r_record = new type_asset_value_2_record_2_fields.r_record(new Nat(2), "mystr");
  ...
  it('record_3_fields', async () => {
    const v : type_asset_value_2_record_3_fields.r_record = new type_asset_value_2_record_3_fields.r_record(new Nat(2), "mystr", new Bytes("02"));
  ...
  it('record_4_fields', async () => {
    const v : type_asset_value_2_record_4_fields.r_record = new type_asset_value_2_record_4_fields.r_record(new Nat(2), "mystr", new Bytes("02"), true);
  ...
  it('record_4_fields_custom', async () => {
    const v : type_asset_value_2_record_4_fields_custom.r_record = new type_asset_value_2_record_4_fields_custom.r_record(new Nat(2), "mystr", new Bytes("02"), true);
  ...
  it('record_complex', async () => {
    const v : type_asset_value_2_record_complex.r_record = new type_asset_value_2_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date("2022-12-31T23:59:59Z"), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] );
    await type_asset_value_2_record_complex.type_asset_value_2_record_complex.deploy({ as: alice });
    await type_asset_value_2_record_complex.type_asset_value_2_record_complex.asset_put(v, { as: alice });
    const res = await type_asset_value_2_record_complex.type_asset_value_2_record_complex.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
