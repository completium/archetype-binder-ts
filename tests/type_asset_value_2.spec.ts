...
describe('Type asset_value_2', () => {
  ...
  it('enum_param', async () => {
    ...
    assert(1 == res.length && ((x : type_asset_value_2_enum_param.e_enum, y : type_asset_value_2_enum_param.e_enum) => {return x.toString() == y.toString()})(v, res[0][1]), "Invalid Value")
  });
