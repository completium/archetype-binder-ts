...
describe('Type asset_value_2', async () => {
  ...
  it('enum_simple', async () => {
    const v : type_asset_value_2_enum_simple.enum_simple = new type_asset_value_2_enum_simple.e_2();
    ...
    assert(1 == res.length && ((x : type_asset_value_2_enum_simple.enum_simple, y : type_asset_value_2_enum_simple.enum_simple) => {return x.toString() == y.toString()})(v, res[0][1]), "Invalid Value")
  });
