...
import { type_parameter_address } from './contracts/bindings/type_parameter_address'
import { type_parameter_bls12_381_fr } from './contracts/bindings/type_parameter_bls12_381_fr'
import { type_parameter_bls12_381_g1 } from './contracts/bindings/type_parameter_bls12_381_g1'
import { type_parameter_bls12_381_g2 } from './contracts/bindings/type_parameter_bls12_381_g2'
import { type_parameter_bool } from './contracts/bindings/type_parameter_bool'
import { type_parameter_bytes } from './contracts/bindings/type_parameter_bytes'
import { type_parameter_chain_id } from './contracts/bindings/type_parameter_chain_id'
//import { type_parameter_chest } from './contracts/bindings/type_parameter_chest'
//import { type_parameter_chest_key } from './contracts/bindings/type_parameter_chest_key'
import { type_parameter_date } from './contracts/bindings/type_parameter_date'
import { type_parameter_duration } from './contracts/bindings/type_parameter_duration'
import { type_parameter_int } from './contracts/bindings/type_parameter_int'
import { type_parameter_key } from './contracts/bindings/type_parameter_key'
import { type_parameter_key_hash } from './contracts/bindings/type_parameter_key_hash'
import { type_parameter_nat } from './contracts/bindings/type_parameter_nat'
import { type_parameter_rational } from './contracts/bindings/type_parameter_rational'
//import { type_parameter_sapling_transaction } from './contracts/bindings/type_parameter_sapling_transaction'
//import { type_parameter_signature } from './contracts/bindings/type_parameter_signature'
import { type_parameter_string } from './contracts/bindings/type_parameter_string'
import { type_parameter_tez } from './contracts/bindings/type_parameter_tez'
import { type_parameter_unit } from './contracts/bindings/type_parameter_unit'
import { type_parameter_list_nat } from './contracts/bindings/type_parameter_list_nat'
import { type_parameter_list_string } from './contracts/bindings/type_parameter_list_string'
import { type_parameter_list_bool } from './contracts/bindings/type_parameter_list_bool'
import { type_parameter_map_nat_string } from './contracts/bindings/type_parameter_map_nat_string'
import { type_parameter_option_nat } from './contracts/bindings/type_parameter_option_nat'
import { type_parameter_option_string } from './contracts/bindings/type_parameter_option_string'
import { type_parameter_option_bool } from './contracts/bindings/type_parameter_option_bool'
//import { type_parameter_or_nat_string } from './contracts/bindings/type_parameter_or_nat_string'
import { type_parameter_set_nat } from './contracts/bindings/type_parameter_set_nat'
import { type_parameter_set_string } from './contracts/bindings/type_parameter_set_string'
import { type_parameter_set_bool } from './contracts/bindings/type_parameter_set_bool'
import { type_parameter_tuple_nat_string } from './contracts/bindings/type_parameter_tuple_nat_string'
import { type_parameter_tuple_nat_string_bytes } from './contracts/bindings/type_parameter_tuple_nat_string_bytes'
import { type_parameter_tuple_nat_string_bytes_bool } from './contracts/bindings/type_parameter_tuple_nat_string_bytes_bool'
import { type_parameter_tuple_nat_string_bytes_rev } from './contracts/bindings/type_parameter_tuple_nat_string_bytes_rev'
import { type_parameter_tuple_nat_string_bytes_bool_rev } from './contracts/bindings/type_parameter_tuple_nat_string_bytes_bool_rev'
import { type_parameter_tuple_nat_string_bytes_bool_custom } from './contracts/bindings/type_parameter_tuple_nat_string_bytes_bool_custom'
...
describe('Type parameter', async () => {
  ...
  it('address', async () => {
    ...
    await type_parameter_address.deploy(v, { as: alice });
    const res = await type_parameter_address.get_res();
  ...
  it('bls12_381_fr', async () => {
    ...
    await type_parameter_bls12_381_fr.deploy(v, { as: alice });
    const res = await type_parameter_bls12_381_fr.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g1', async () => {
    ...
    await type_parameter_bls12_381_g1.deploy(v, { as: alice });
    const res = await type_parameter_bls12_381_g1.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    await type_parameter_bls12_381_g2.deploy(v, { as: alice });
    const res = await type_parameter_bls12_381_g2.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bool', async () => {
    ...
    await type_parameter_bool.deploy(v, { as: alice });
    const res = await type_parameter_bool.get_res();
  ...
  it('bytes', async () => {
    ...
    await type_parameter_bytes.deploy(v, { as: alice });
    const res = await type_parameter_bytes.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('chain_id', async () => {
    ...
    await type_parameter_chain_id.deploy(v, { as: alice });
    const res = await type_parameter_chain_id.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('chest', async () => {
    ...
    await type_parameter_chest.deploy(v, { as: alice });
    const res = await type_parameter_chest.get_res();
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    await type_parameter_chest_key.deploy(v, { as: alice });
    const res = await type_parameter_chest_key.get_res();
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('date', async () => {
    ...
    await type_parameter_date.deploy(v, { as: alice });
    const res = await type_parameter_date.get_res();
  ...
  it('duration', async () => {
    ...
    await type_parameter_duration.deploy(v, { as: alice });
    const res = await type_parameter_duration.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('int', async () => {
    ...
    await type_parameter_int.deploy(v, { as: alice });
    const res = await type_parameter_int.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key', async () => {
    ...
    await type_parameter_key.deploy(v, { as: alice });
    const res = await type_parameter_key.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key_hash', async () => {
    ...
    await type_parameter_key_hash.deploy(v, { as: alice });
    const res = await type_parameter_key_hash.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('nat', async () => {
    ...
    await type_parameter_nat.deploy(v, { as: alice });
    const res = await type_parameter_nat.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('rational', async () => {
    ...
    await type_parameter_rational.deploy(v, { as: alice });
    const res = await type_parameter_rational.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    await type_parameter_sapling_transaction.deploy(v, { as: alice });
    const res = await type_parameter_sapling_transaction.get_res();
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('signature', async () => {
    ...
    await type_parameter_signature.deploy(v, { as: alice });
    const res = await type_parameter_signature.get_res();
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('string', async () => {
    ...
    await type_parameter_string.deploy(v, { as: alice });
    const res = await type_parameter_string.get_res();
  ...
  it('tez', async () => {
    ...
    await type_parameter_tez.deploy(v, { as: alice });
    const res = await type_parameter_tez.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('unit', async () => {
    ...
    await type_parameter_unit.deploy(v, { as: alice });
    const res = await type_parameter_unit.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('list_nat', async () => {
    ...
    await type_parameter_list_nat.deploy(v, { as: alice });
    const res = await type_parameter_list_nat.get_res();
  ...
  it('list_string', async () => {
    ...
    await type_parameter_list_string.deploy(v, { as: alice });
    const res = await type_parameter_list_string.get_res();
  ...
  it('list_bool', async () => {
    ...
    await type_parameter_list_bool.deploy(v, { as: alice });
    const res = await type_parameter_list_bool.get_res();
  ...
  it('map_nat_string', async () => {
    ...
    await type_parameter_map_nat_string.deploy(v, { as: alice });
    const res = await type_parameter_map_nat_string.get_res();
  ...
  it('option_nat', async () => {
    ...
    await type_parameter_option_nat.deploy(v, { as: alice });
    const res = await type_parameter_option_nat.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_string', async () => {
    ...
    await type_parameter_option_string.deploy(v, { as: alice });
    const res = await type_parameter_option_string.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_bool', async () => {
    ...
    await type_parameter_option_bool.deploy(v, { as: alice });
    const res = await type_parameter_option_bool.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('or_nat_string', async () => {
    ...
    await type_parameter_or_nat_string.deploy(v, { as: alice });
    const res = await type_parameter_or_nat_string.get_res();
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('set_nat', async () => {
    ...
    await type_parameter_set_nat.deploy(v, { as: alice });
    const res = await type_parameter_set_nat.get_res();
  ...
  it('set_string', async () => {
    ...
    await type_parameter_set_string.deploy(v, { as: alice });
    const res = await type_parameter_set_string.get_res();
  ...
  it('set_bool', async () => {
    ...
    await type_parameter_set_bool.deploy(v, { as: alice });
    const res = await type_parameter_set_bool.get_res();
  ...
  it('tuple_nat_string', async () => {
    ...
    await type_parameter_tuple_nat_string.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string.get_res();
  ...
  it('tuple_nat_string_bytes', async () => {
    ...
    await type_parameter_tuple_nat_string_bytes.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string_bytes.get_res();
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    await type_parameter_tuple_nat_string_bytes_bool.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string_bytes_bool.get_res();
  ...
  it('tuple_nat_string_bytes_rev', async () => {
    const v : [[Nat, string], Bytes] = [[new Nat(2), "toto"], new Bytes("ff")];
    await type_parameter_tuple_nat_string_bytes_rev.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string_bytes_rev.get_res();
  ...
  it('tuple_nat_string_bytes_bool_rev', async () => {
    const v : [[[Nat, string], Bytes], boolean] = [[[new Nat(2), "toto"], new Bytes("ff")], true];
    await type_parameter_tuple_nat_string_bytes_bool_rev.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string_bytes_bool_rev.get_res();
  ...
  it('tuple_nat_string_bytes_bool_custom', async () => {
    const v : [Nat, [string, Bytes], boolean] = [new Nat(2), ["toto", new Bytes("ff")], true];
    await type_parameter_tuple_nat_string_bytes_bool_custom.deploy(v, { as: alice });
    const res = await type_parameter_tuple_nat_string_bytes_bool_custom.get_res();
