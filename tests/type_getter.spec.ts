...
import * as type_getter_address from './contracts/bindings/type_getter_address'
import * as type_getter_bls12_381_fr from './contracts/bindings/type_getter_bls12_381_fr'
import * as type_getter_bls12_381_g1 from './contracts/bindings/type_getter_bls12_381_g1'
import * as type_getter_bls12_381_g2 from './contracts/bindings/type_getter_bls12_381_g2'
import * as type_getter_bool from './contracts/bindings/type_getter_bool'
import * as type_getter_bytes from './contracts/bindings/type_getter_bytes'
import * as type_getter_chain_id from './contracts/bindings/type_getter_chain_id'
//import * as type_getter_chest from './contracts/bindings/type_getter_chest'
//import * as type_getter_chest_key from './contracts/bindings/type_getter_chest_key'
import * as type_getter_date from './contracts/bindings/type_getter_date'
import * as type_getter_duration from './contracts/bindings/type_getter_duration'
import * as type_getter_int from './contracts/bindings/type_getter_int'
import * as type_getter_key from './contracts/bindings/type_getter_key'
import * as type_getter_key_hash from './contracts/bindings/type_getter_key_hash'
...
import * as type_getter_tx_rollup_l2_address from './contracts/bindings/type_getter_tx_rollup_l2_address'
import * as type_getter_unit from './contracts/bindings/type_getter_unit'
import * as type_getter_list_nat from './contracts/bindings/type_getter_list_nat'
import * as type_getter_list_string from './contracts/bindings/type_getter_list_string'
import * as type_getter_list_bool from './contracts/bindings/type_getter_list_bool'
import * as type_getter_map_nat_string from './contracts/bindings/type_getter_map_nat_string'
...
import * as type_getter_tuple_nat_string from './contracts/bindings/type_getter_tuple_nat_string'
import * as type_getter_tuple_nat_string_bytes from './contracts/bindings/type_getter_tuple_nat_string_bytes'
import * as type_getter_tuple_nat_string_bytes_bool from './contracts/bindings/type_getter_tuple_nat_string_bytes_bool'
import * as type_getter_tuple_nat_string_bytes_rev from './contracts/bindings/type_getter_tuple_nat_string_bytes_rev'
...
import * as type_getter_enum_param from './contracts/bindings/type_getter_enum_param'
...
import * as type_getter_record_complex from './contracts/bindings/type_getter_record_complex'
...
describe('Type getter', () => {
  ...
  it('address', async () => {
    ...
    await type_getter_address.type_getter_address.deploy({ as: alice });
    const res = await type_getter_address.type_getter_address.get_value(v, { as: alice });
    const s = await type_getter_address.type_getter_address.get_res();
  ...
  it('bls12_381_g1', async () => {
    ...
    await type_getter_bls12_381_g1.type_getter_bls12_381_g1.deploy({ as: alice });
    const res = await type_getter_bls12_381_g1.type_getter_bls12_381_g1.get_value(v, { as: alice });
    const s = await type_getter_bls12_381_g1.type_getter_bls12_381_g1.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    await type_getter_bls12_381_g2.type_getter_bls12_381_g2.deploy({ as: alice });
    const res = await type_getter_bls12_381_g2.type_getter_bls12_381_g2.get_value(v, { as: alice });
    const s = await type_getter_bls12_381_g2.type_getter_bls12_381_g2.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('bool', async () => {
    ...
    await type_getter_bool.type_getter_bool.deploy({ as: alice });
    const res = await type_getter_bool.type_getter_bool.get_value(v, { as: alice });
    const s = await type_getter_bool.type_getter_bool.get_res();
    assert(((x : boolean, y : boolean) => {return x == y})(v, res), "Invalid Value");
    assert(((x : boolean, y : boolean) => {return x == y})(v, s), "Invalid Value");
  });

  // bytes
  it('bytes', async () => {
    const v : Bytes = new Bytes("ff");
    await type_getter_bytes.type_getter_bytes.deploy({ as: alice });
    const res = await type_getter_bytes.type_getter_bytes.get_value(v, { as: alice });
    const s = await type_getter_bytes.type_getter_bytes.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('chain_id', async () => {
    ...
    await type_getter_chain_id.type_getter_chain_id.deploy({ as: alice });
    const res = await type_getter_chain_id.type_getter_chain_id.get_value(v, { as: alice });
    const s = await type_getter_chain_id.type_getter_chain_id.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  /*it('chest', async () => {
    ...
    await type_getter_chest.type_getter_chest.deploy({ as: alice });
    const res = await type_getter_chest.type_getter_chest.get_value(v, { as: alice });
    const s = await type_getter_chest.type_getter_chest.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    await type_getter_chest_key.type_getter_chest_key.deploy({ as: alice });
    const res = await type_getter_chest_key.type_getter_chest_key.get_value(v, { as: alice });
    const s = await type_getter_chest_key.type_getter_chest_key.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });*/
  ...
  it('date', async () => {
    ...
    await type_getter_date.type_getter_date.deploy({ as: alice });
    const res = await type_getter_date.type_getter_date.get_value(v, { as: alice });
    const s = await type_getter_date.type_getter_date.get_res();
    assert(((x : Date, y : Date) => {return x.toISOString() == y.toISOString()})(v, res), "Invalid Value");
    assert(((x : Date, y : Date) => {return x.toISOString() == y.toISOString()})(v, s), "Invalid Value");
  });

  // duration
  it('duration', async () => {
    const v : Duration = new Duration("2m");
    await type_getter_duration.type_getter_duration.deploy({ as: alice });
    const res = await type_getter_duration.type_getter_duration.get_value(v, { as: alice });
    const s = await type_getter_duration.type_getter_duration.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('int', async () => {
    ...
    await type_getter_int.type_getter_int.deploy({ as: alice });
    const res = await type_getter_int.type_getter_int.get_value(v, { as: alice });
    const s = await type_getter_int.type_getter_int.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('key', async () => {
    ...
    await type_getter_key.type_getter_key.deploy({ as: alice });
    const res = await type_getter_key.type_getter_key.get_value(v, { as: alice });
    const s = await type_getter_key.type_getter_key.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('key_hash', async () => {
    ...
    await type_getter_key_hash.type_getter_key_hash.deploy({ as: alice });
    const res = await type_getter_key_hash.type_getter_key_hash.get_value(v, { as: alice });
    const s = await type_getter_key_hash.type_getter_key_hash.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('nat', async () => {
    ...
    await type_getter_nat.type_getter_nat.deploy({ as: alice });
    const res = await type_getter_nat.type_getter_nat.get_value(v, { as: alice });
    const s = await type_getter_nat.type_getter_nat.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('rational', async () => {
    ...
    await type_getter_rational.type_getter_rational.deploy({ as: alice });
    const res = await type_getter_rational.type_getter_rational.get_value(v, { as: alice });
    const s = await type_getter_rational.type_getter_rational.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    await type_getter_sapling_transaction.type_getter_sapling_transaction.deploy({ as: alice });
    const res = await type_getter_sapling_transaction.type_getter_sapling_transaction.get_value(v, { as: alice });
    const s = await type_getter_sapling_transaction.type_getter_sapling_transaction.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });*/
  ...
  it('string', async () => {
    ...
    await type_getter_string.type_getter_string.deploy({ as: alice });
    const res = await type_getter_string.type_getter_string.get_value(v, { as: alice });
    const s = await type_getter_string.type_getter_string.get_res();
    assert(((x : string, y : string) => {return x == y})(v, res), "Invalid Value");
    assert(((x : string, y : string) => {return x == y})(v, s), "Invalid Value");
  });

  // tez
  it('tez', async () => {
    const v : Tez = new Tez(2);
    await type_getter_tez.type_getter_tez.deploy({ as: alice });
    const res = await type_getter_tez.type_getter_tez.get_value(v, { as: alice });
    const s = await type_getter_tez.type_getter_tez.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('tx_rollup_l2_address', async () => {
    ...
    await type_getter_tx_rollup_l2_address.type_getter_tx_rollup_l2_address.deploy({ as: alice });
    const res = await type_getter_tx_rollup_l2_address.type_getter_tx_rollup_l2_address.get_value(v, { as: alice });
    const s = await type_getter_tx_rollup_l2_address.type_getter_tx_rollup_l2_address.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('unit', async () => {
    ...
    await type_getter_unit.type_getter_unit.deploy({ as: alice });
    const res = await type_getter_unit.type_getter_unit.get_value(v, { as: alice });
    const s = await type_getter_unit.type_getter_unit.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('list_nat', async () => {
    ...
    await type_getter_list_nat.type_getter_list_nat.deploy({ as: alice });
    const res = await type_getter_list_nat.type_getter_list_nat.get_value(v, { as: alice });
    const s = await type_getter_list_nat.type_getter_list_nat.get_res();
    assert(((x : Array<Nat>, y : Array<Nat>) => {return x.length == y.length && x[0].equals(y[0]) && x[1].equals(y[1]) && x[2].equals(y[2])})(v, res), "Invalid Value");
    assert(((x : Array<Nat>, y : Array<Nat>) => {return x.length == y.length && x[0].equals(y[0]) && x[1].equals(y[1]) && x[2].equals(y[2])})(v, s), "Invalid Value");
  });

  // list_string
  it('list_string', async () => {
    const v : Array<string> = ["a", "b", "c", "d"];
    await type_getter_list_string.type_getter_list_string.deploy({ as: alice });
    const res = await type_getter_list_string.type_getter_list_string.get_value(v, { as: alice });
    const s = await type_getter_list_string.type_getter_list_string.get_res();
    assert(((x : Array<string>, y : Array<string>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1] && x[2] == y[2] && x[3] == y[3]})(v, res), "Invalid Value");
    assert(((x : Array<string>, y : Array<string>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1] && x[2] == y[2] && x[3] == y[3]})(v, s), "Invalid Value");
  });

  // list_bool
  it('list_bool', async () => {
    const v : Array<boolean> = [true, false, true, true];
    await type_getter_list_bool.type_getter_list_bool.deploy({ as: alice });
    const res = await type_getter_list_bool.type_getter_list_bool.get_value(v, { as: alice });
    const s = await type_getter_list_bool.type_getter_list_bool.get_res();
    assert(((x : Array<boolean>, y : Array<boolean>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1] && x[2] == y[2] && x[3] == y[3]})(v, res), "Invalid Value");
    assert(((x : Array<boolean>, y : Array<boolean>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1] && x[2] == y[2] && x[3] == y[3]})(v, s), "Invalid Value");
  });

  // map_nat_string
  it('map_nat_string', async () => {
    const v : Array<[Nat, string]> = [[new Nat(0), "mystr"]];
    await type_getter_map_nat_string.type_getter_map_nat_string.deploy({ as: alice });
    const res = await type_getter_map_nat_string.type_getter_map_nat_string.get_value(v, { as: alice });
    const s = await type_getter_map_nat_string.type_getter_map_nat_string.get_res();
    assert(((x : Array<[Nat, string]>, y : Array<[Nat, string]>) => {return x.length == y.length && x[0][0].equals(y[0][0]) && x[0][1] == y[0][1]})(v, res), "Invalid Value");
    assert(((x : Array<[Nat, string]>, y : Array<[Nat, string]>) => {return x.length == y.length && x[0][0].equals(y[0][0]) && x[0][1] == y[0][1]})(v, s), "Invalid Value");
  });

  // option_nat
  it('option_nat', async () => {
    const v : Option<Nat> = Option.Some(new Nat(2));
    await type_getter_option_nat.type_getter_option_nat.deploy({ as: alice });
    const res = await type_getter_option_nat.type_getter_option_nat.get_value(v, { as: alice });
    const s = await type_getter_option_nat.type_getter_option_nat.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('option_string', async () => {
    ...
    await type_getter_option_string.type_getter_option_string.deploy({ as: alice });
    const res = await type_getter_option_string.type_getter_option_string.get_value(v, { as: alice });
    const s = await type_getter_option_string.type_getter_option_string.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('option_bool', async () => {
    ...
    await type_getter_option_bool.type_getter_option_bool.deploy({ as: alice });
    const res = await type_getter_option_bool.type_getter_option_bool.get_value(v, { as: alice });
    const s = await type_getter_option_bool.type_getter_option_bool.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
  ...
  it('set_nat', async () => {
    ...
    await type_getter_set_nat.type_getter_set_nat.deploy({ as: alice });
    const res = await type_getter_set_nat.type_getter_set_nat.get_value(v, { as: alice });
    const s = await type_getter_set_nat.type_getter_set_nat.get_res();
    assert(((x : Array<Nat>, y : Array<Nat>) => {return x.length == y.length && x[0].equals(y[0])})(v, res), "Invalid Value");
    assert(((x : Array<Nat>, y : Array<Nat>) => {return x.length == y.length && x[0].equals(y[0])})(v, s), "Invalid Value");
  });

  // set_string
  it('set_string', async () => {
    const v : Array<string> = ["a", "b"];
    await type_getter_set_string.type_getter_set_string.deploy({ as: alice });
    const res = await type_getter_set_string.type_getter_set_string.get_value(v, { as: alice });
    const s = await type_getter_set_string.type_getter_set_string.get_res();
    assert(((x : Array<string>, y : Array<string>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1]})(v, res), "Invalid Value");
    assert(((x : Array<string>, y : Array<string>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1]})(v, s), "Invalid Value");
  });

  // set_bool
  it('set_bool', async () => {
    const v : Array<boolean> = [false, true];
    await type_getter_set_bool.type_getter_set_bool.deploy({ as: alice });
    const res = await type_getter_set_bool.type_getter_set_bool.get_value(v, { as: alice });
    const s = await type_getter_set_bool.type_getter_set_bool.get_res();
    assert(((x : Array<boolean>, y : Array<boolean>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1]})(v, res), "Invalid Value");
    assert(((x : Array<boolean>, y : Array<boolean>) => {return x.length == y.length && x[0] == y[0] && x[1] == y[1]})(v, s), "Invalid Value");
  });

  // tuple_nat_string
  it('tuple_nat_string', async () => {
    const v : [Nat, string] = [new Nat(2), "mystring"];
    await type_getter_tuple_nat_string.type_getter_tuple_nat_string.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string.type_getter_tuple_nat_string.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string.type_getter_tuple_nat_string.get_res();
    assert(((x : [Nat, string], y : [Nat, string]) => {return x[0].equals(y[0]) && x[1] == y[1]})(v, res), "Invalid Value");
    assert(((x : [Nat, string], y : [Nat, string]) => {return x[0].equals(y[0]) && x[1] == y[1]})(v, s), "Invalid Value");
  });

  // tuple_nat_string_bytes
  it('tuple_nat_string_bytes', async () => {
    const v : [Nat, string, Bytes] = [new Nat(2), "toto", new Bytes("ff")];
    await type_getter_tuple_nat_string_bytes.type_getter_tuple_nat_string_bytes.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string_bytes.type_getter_tuple_nat_string_bytes.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string_bytes.type_getter_tuple_nat_string_bytes.get_res();
    assert(((x : [Nat, string, Bytes], y : [Nat, string, Bytes]) => {return x[0].equals(y[0]) && x[1] == y[1] && x[2].equals(y[2])})(v, res), "Invalid Value");
    assert(((x : [Nat, string, Bytes], y : [Nat, string, Bytes]) => {return x[0].equals(y[0]) && x[1] == y[1] && x[2].equals(y[2])})(v, s), "Invalid Value");
  });
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    await type_getter_tuple_nat_string_bytes_bool.type_getter_tuple_nat_string_bytes_bool.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string_bytes_bool.type_getter_tuple_nat_string_bytes_bool.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string_bytes_bool.type_getter_tuple_nat_string_bytes_bool.get_res();
    ...
    assert(((x : [Nat, string, Bytes, boolean], y : [Nat, string, Bytes, boolean]) => {return x[0].equals(y[0]) && x[1] == y[1] && x[2].equals(y[2]) && x[3] == y[3]})(v, s), "Invalid Value");
  });

  // tuple_nat_string_bytes_rev
  it('tuple_nat_string_bytes_rev', async () => {
    const v : [[Nat, string], Bytes] = [[new Nat(2), "toto"], new Bytes("ff")];
    await type_getter_tuple_nat_string_bytes_rev.type_getter_tuple_nat_string_bytes_rev.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string_bytes_rev.type_getter_tuple_nat_string_bytes_rev.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string_bytes_rev.type_getter_tuple_nat_string_bytes_rev.get_res();
    assert(((x : [[Nat, string], Bytes], y : [[Nat, string], Bytes]) => {return x[0][0].equals(y[0][0]) && x[0][1] == y[0][1] && x[1].equals(y[1])})(v, res), "Invalid Value");
    assert(((x : [[Nat, string], Bytes], y : [[Nat, string], Bytes]) => {return x[0][0].equals(y[0][0]) && x[0][1] == y[0][1] && x[1].equals(y[1])})(v, s), "Invalid Value");
  });

  // tuple_nat_string_bytes_bool_rev
  it('tuple_nat_string_bytes_bool_rev', async () => {
    const v : [[[Nat, string], Bytes], boolean] = [[[new Nat(2), "toto"], new Bytes("ff")], true];
    await type_getter_tuple_nat_string_bytes_bool_rev.type_getter_tuple_nat_string_bytes_bool_rev.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string_bytes_bool_rev.type_getter_tuple_nat_string_bytes_bool_rev.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string_bytes_bool_rev.type_getter_tuple_nat_string_bytes_bool_rev.get_res();
    ...
    assert(((x : [[[Nat, string], Bytes], boolean], y : [[[Nat, string], Bytes], boolean]) => {return x[0][0][0].equals(y[0][0][0]) && x[0][0][1] == y[0][0][1] && x[0][1].equals(y[0][1]) && x[1] == y[1]})(v, s), "Invalid Value");
  });

  // tuple_nat_string_bytes_bool_custom
  it('tuple_nat_string_bytes_bool_custom', async () => {
    const v : [Nat, [string, Bytes], boolean] = [new Nat(2), ["toto", new Bytes("ff")], true];
    await type_getter_tuple_nat_string_bytes_bool_custom.type_getter_tuple_nat_string_bytes_bool_custom.deploy({ as: alice });
    const res = await type_getter_tuple_nat_string_bytes_bool_custom.type_getter_tuple_nat_string_bytes_bool_custom.get_value(v, { as: alice });
    const s = await type_getter_tuple_nat_string_bytes_bool_custom.type_getter_tuple_nat_string_bytes_bool_custom.get_res();
    ...
    assert(((x : [Nat, [string, Bytes], boolean], y : [Nat, [string, Bytes], boolean]) => {return x[0].equals(y[0]) && x[1][0] == y[1][0] && x[1][1].equals(y[1][1]) && x[2] == y[2]})(v, s), "Invalid Value");
  });
  ...
  // enum_param
  it('enum_param', async () => {
    const v : type_getter_enum_param.e_enum = new type_getter_enum_param.e_2(new Nat(2));
    await type_getter_enum_param.type_getter_enum_param.deploy({ as: alice });
    const res = await type_getter_enum_param.type_getter_enum_param.get_value(v, { as: alice });
    const s = await type_getter_enum_param.type_getter_enum_param.get_res();
    assert(((x : type_getter_enum_param.e_enum, y : type_getter_enum_param.e_enum) => {return x.toString() == y.toString()})(v, res), "Invalid Value");
    assert(((x : type_getter_enum_param.e_enum, y : type_getter_enum_param.e_enum) => {return x.toString() == y.toString()})(v, s), "Invalid Value");
  });
  ...
  it('record_complex', async () => {
    const v : type_getter_record_complex.r_record = new type_getter_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date("2022-12-31T23:59:59Z"), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] );
    await type_getter_record_complex.type_getter_record_complex.deploy({ as: alice });
    const res = await type_getter_record_complex.type_getter_record_complex.get_value(v, { as: alice });
    const s = await type_getter_record_complex.type_getter_record_complex.get_res();
    assert(v.equals(res), "Invalid Value");
    assert(v.equals(s), "Invalid Value");
  });
