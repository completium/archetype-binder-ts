...
describe('Type getter', () => {
  ...
  it('record_complex', async () => {
    const v : type_getter_record_complex.r_record = new type_getter_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date(), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] );
