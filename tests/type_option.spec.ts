...
import * as type_option_tx_rollup_l2_address from './contracts/bindings/type_option_tx_rollup_l2_address'
...
import * as type_option_enum_param from './contracts/bindings/type_option_enum_param'
...
import * as type_option_record_complex from './contracts/bindings/type_option_record_complex'
...
describe('Type option', () => {
  ...
  it('tx_rollup_l2_address', async () => {
    const v : Option<Tx_rollup_l2_address> = new Option<Tx_rollup_l2_address>(new Tx_rollup_l2_address("tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm"));
    await type_option_tx_rollup_l2_address.type_option_tx_rollup_l2_address.deploy({ as: alice });
    await type_option_tx_rollup_l2_address.type_option_tx_rollup_l2_address.set_value(v, { as: alice });
    const res = await type_option_tx_rollup_l2_address.type_option_tx_rollup_l2_address.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  // enum_param
  it('enum_param', async () => {
    const v : Option<type_option_enum_param.e_enum> = new Option<type_option_enum_param.e_enum>(new type_option_enum_param.e_2(new Nat(2)));
    await type_option_enum_param.type_option_enum_param.deploy({ as: alice });
    await type_option_enum_param.type_option_enum_param.set_value(v, { as: alice });
    const res = await type_option_enum_param.type_option_enum_param.get_res();
    assert(v.equals(res), "Invalid Value")
  });

  // record_1_field
  it('record_1_field', async () => {
    const v : Option<type_option_record_1_field.r_record> = new Option<type_option_record_1_field.r_record>(new type_option_record_1_field.r_record(new Nat(2)));
  ...
  it('record_complex', async () => {
    const v : Option<type_option_record_complex.r_record> = new Option<type_option_record_complex.r_record>(new type_option_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date("2022-12-31T23:59:59Z"), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] ));
    await type_option_record_complex.type_option_record_complex.deploy({ as: alice });
    await type_option_record_complex.type_option_record_complex.set_value(v, { as: alice });
    const res = await type_option_record_complex.type_option_record_complex.get_res();
    assert(v.equals(res), "Invalid Value")
  });
