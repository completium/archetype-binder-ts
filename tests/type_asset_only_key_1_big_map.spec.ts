...
import * as type_asset_only_key_1_big_map_address from './contracts/bindings/type_asset_only_key_1_big_map_address'
import * as type_asset_only_key_1_big_map_bool from './contracts/bindings/type_asset_only_key_1_big_map_bool'
import * as type_asset_only_key_1_big_map_bytes from './contracts/bindings/type_asset_only_key_1_big_map_bytes'
import * as type_asset_only_key_1_big_map_chain_id from './contracts/bindings/type_asset_only_key_1_big_map_chain_id'
import * as type_asset_only_key_1_big_map_date from './contracts/bindings/type_asset_only_key_1_big_map_date'
import * as type_asset_only_key_1_big_map_duration from './contracts/bindings/type_asset_only_key_1_big_map_duration'
import * as type_asset_only_key_1_big_map_int from './contracts/bindings/type_asset_only_key_1_big_map_int'
import * as type_asset_only_key_1_big_map_key from './contracts/bindings/type_asset_only_key_1_big_map_key'
import * as type_asset_only_key_1_big_map_key_hash from './contracts/bindings/type_asset_only_key_1_big_map_key_hash'
import * as type_asset_only_key_1_big_map_nat from './contracts/bindings/type_asset_only_key_1_big_map_nat'
import * as type_asset_only_key_1_big_map_rational from './contracts/bindings/type_asset_only_key_1_big_map_rational'
import * as type_asset_only_key_1_big_map_signature from './contracts/bindings/type_asset_only_key_1_big_map_signature'
import * as type_asset_only_key_1_big_map_string from './contracts/bindings/type_asset_only_key_1_big_map_string'
import * as type_asset_only_key_1_big_map_tez from './contracts/bindings/type_asset_only_key_1_big_map_tez'
import * as type_asset_only_key_1_big_map_tx_rollup_l2_address from './contracts/bindings/type_asset_only_key_1_big_map_tx_rollup_l2_address'
import * as type_asset_only_key_1_big_map_unit from './contracts/bindings/type_asset_only_key_1_big_map_unit'
import * as type_asset_only_key_1_big_map_option_nat from './contracts/bindings/type_asset_only_key_1_big_map_option_nat'
import * as type_asset_only_key_1_big_map_option_string from './contracts/bindings/type_asset_only_key_1_big_map_option_string'
import * as type_asset_only_key_1_big_map_option_bool from './contracts/bindings/type_asset_only_key_1_big_map_option_bool'
import * as type_asset_only_key_1_big_map_or_nat_string from './contracts/bindings/type_asset_only_key_1_big_map_or_nat_string'
import * as type_asset_only_key_1_big_map_tuple_nat_string from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string'
import * as type_asset_only_key_1_big_map_tuple_nat_string_bytes from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string_bytes'
import * as type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool'
import * as type_asset_only_key_1_big_map_tuple_nat_string_bytes_rev from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string_bytes_rev'
import * as type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool_rev from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool_rev'
import * as type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool_custom from './contracts/bindings/type_asset_only_key_1_big_map_tuple_nat_string_bytes_bool_custom'
import * as type_asset_only_key_1_big_map_enum_simple from './contracts/bindings/type_asset_only_key_1_big_map_enum_simple'
import * as type_asset_only_key_1_big_map_enum_param from './contracts/bindings/type_asset_only_key_1_big_map_enum_param'
import * as type_asset_only_key_1_big_map_record_1_field from './contracts/bindings/type_asset_only_key_1_big_map_record_1_field'
import * as type_asset_only_key_1_big_map_record_2_fields from './contracts/bindings/type_asset_only_key_1_big_map_record_2_fields'
import * as type_asset_only_key_1_big_map_record_3_fields from './contracts/bindings/type_asset_only_key_1_big_map_record_3_fields'
import * as type_asset_only_key_1_big_map_record_4_fields from './contracts/bindings/type_asset_only_key_1_big_map_record_4_fields'
import * as type_asset_only_key_1_big_map_record_4_fields_custom from './contracts/bindings/type_asset_only_key_1_big_map_record_4_fields_custom'
...
describe('Type asset_only_key_1_big_map', () => {
  // address
  it('address', async () => {
