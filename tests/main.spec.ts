...
import { expect_to_fail, get_account, Address, Nat, Int, Tez, set_mockup, set_quiet, Unit, Bytes, Key_hash, Chain_id, Bls12_381_fr, Duration, Rational, Chest, Chest_key, Bls12_381_g1, Sapling_transaction } from '@completium/experiment-ts';
...
describe('Simple type', async () => {
  ...
  it('bls12_381_g2', async () => {
    const v = new Bls12_381_g1('');
