...
import * as type_asset_value_3_address from './contracts/bindings/type_asset_value_3_address'
import * as type_asset_value_3_bls12_381_fr from './contracts/bindings/type_asset_value_3_bls12_381_fr'
import * as type_asset_value_3_bls12_381_g1 from './contracts/bindings/type_asset_value_3_bls12_381_g1'
import * as type_asset_value_3_bls12_381_g2 from './contracts/bindings/type_asset_value_3_bls12_381_g2'
import * as type_asset_value_3_bool from './contracts/bindings/type_asset_value_3_bool'
import * as type_asset_value_3_bytes from './contracts/bindings/type_asset_value_3_bytes'
import * as type_asset_value_3_chain_id from './contracts/bindings/type_asset_value_3_chain_id'
//import * as type_asset_value_3_chest from './contracts/bindings/type_asset_value_3_chest'
//import * as type_asset_value_3_chest_key from './contracts/bindings/type_asset_value_3_chest_key'
import * as type_asset_value_3_date from './contracts/bindings/type_asset_value_3_date'
import * as type_asset_value_3_duration from './contracts/bindings/type_asset_value_3_duration'
import * as type_asset_value_3_int from './contracts/bindings/type_asset_value_3_int'
import * as type_asset_value_3_key from './contracts/bindings/type_asset_value_3_key'
import * as type_asset_value_3_key_hash from './contracts/bindings/type_asset_value_3_key_hash'
...
import * as type_asset_value_3_tx_rollup_l2_address from './contracts/bindings/type_asset_value_3_tx_rollup_l2_address'
import * as type_asset_value_3_unit from './contracts/bindings/type_asset_value_3_unit'
import * as type_asset_value_3_list_nat from './contracts/bindings/type_asset_value_3_list_nat'
import * as type_asset_value_3_list_string from './contracts/bindings/type_asset_value_3_list_string'
import * as type_asset_value_3_list_bool from './contracts/bindings/type_asset_value_3_list_bool'
import * as type_asset_value_3_map_nat_string from './contracts/bindings/type_asset_value_3_map_nat_string'
...
import * as type_asset_value_3_tuple_nat_string from './contracts/bindings/type_asset_value_3_tuple_nat_string'
import * as type_asset_value_3_tuple_nat_string_bytes from './contracts/bindings/type_asset_value_3_tuple_nat_string_bytes'
import * as type_asset_value_3_tuple_nat_string_bytes_bool from './contracts/bindings/type_asset_value_3_tuple_nat_string_bytes_bool'
import * as type_asset_value_3_tuple_nat_string_bytes_rev from './contracts/bindings/type_asset_value_3_tuple_nat_string_bytes_rev'
...
describe('Type asset_value_3', () => {
  // address
  it('address', async () => {
    const v : Address = new Address("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb");
    await type_asset_value_3_address.type_asset_value_3_address.deploy({ as: alice });
    await type_asset_value_3_address.type_asset_value_3_address.asset_put(v, { as: alice });
    const res = await type_asset_value_3_address.type_asset_value_3_address.get_my_asset();
  ...
  it('bls12_381_fr', async () => {
    ...
    await type_asset_value_3_bls12_381_fr.type_asset_value_3_bls12_381_fr.deploy({ as: alice });
    await type_asset_value_3_bls12_381_fr.type_asset_value_3_bls12_381_fr.asset_put(v, { as: alice });
    const res = await type_asset_value_3_bls12_381_fr.type_asset_value_3_bls12_381_fr.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('bls12_381_g1', async () => {
    ...
    await type_asset_value_3_bls12_381_g1.type_asset_value_3_bls12_381_g1.deploy({ as: alice });
    await type_asset_value_3_bls12_381_g1.type_asset_value_3_bls12_381_g1.asset_put(v, { as: alice });
    const res = await type_asset_value_3_bls12_381_g1.type_asset_value_3_bls12_381_g1.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    await type_asset_value_3_bls12_381_g2.type_asset_value_3_bls12_381_g2.deploy({ as: alice });
    await type_asset_value_3_bls12_381_g2.type_asset_value_3_bls12_381_g2.asset_put(v, { as: alice });
    const res = await type_asset_value_3_bls12_381_g2.type_asset_value_3_bls12_381_g2.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('bool', async () => {
    ...
    await type_asset_value_3_bool.type_asset_value_3_bool.deploy({ as: alice });
    await type_asset_value_3_bool.type_asset_value_3_bool.asset_put(v, { as: alice });
    const res = await type_asset_value_3_bool.type_asset_value_3_bool.get_my_asset();
  ...
  it('bytes', async () => {
    ...
    await type_asset_value_3_bytes.type_asset_value_3_bytes.deploy({ as: alice });
    await type_asset_value_3_bytes.type_asset_value_3_bytes.asset_put(v, { as: alice });
    const res = await type_asset_value_3_bytes.type_asset_value_3_bytes.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('chain_id', async () => {
    ...
    await type_asset_value_3_chain_id.type_asset_value_3_chain_id.deploy({ as: alice });
    await type_asset_value_3_chain_id.type_asset_value_3_chain_id.asset_put(v, { as: alice });
    const res = await type_asset_value_3_chain_id.type_asset_value_3_chain_id.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  /*it('chest', async () => {
    ...
    await type_asset_value_3_chest.type_asset_value_3_chest.deploy({ as: alice });
    await type_asset_value_3_chest.type_asset_value_3_chest.asset_put(v, { as: alice });
    const res = await type_asset_value_3_chest.type_asset_value_3_chest.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    await type_asset_value_3_chest_key.type_asset_value_3_chest_key.deploy({ as: alice });
    await type_asset_value_3_chest_key.type_asset_value_3_chest_key.asset_put(v, { as: alice });
    const res = await type_asset_value_3_chest_key.type_asset_value_3_chest_key.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });*/
  ...
  it('date', async () => {
    ...
    await type_asset_value_3_date.type_asset_value_3_date.deploy({ as: alice });
    await type_asset_value_3_date.type_asset_value_3_date.asset_put(v, { as: alice });
    const res = await type_asset_value_3_date.type_asset_value_3_date.get_my_asset();
  ...
  it('duration', async () => {
    ...
    await type_asset_value_3_duration.type_asset_value_3_duration.deploy({ as: alice });
    await type_asset_value_3_duration.type_asset_value_3_duration.asset_put(v, { as: alice });
    const res = await type_asset_value_3_duration.type_asset_value_3_duration.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('int', async () => {
    ...
    await type_asset_value_3_int.type_asset_value_3_int.deploy({ as: alice });
    await type_asset_value_3_int.type_asset_value_3_int.asset_put(v, { as: alice });
    const res = await type_asset_value_3_int.type_asset_value_3_int.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('key', async () => {
    ...
    await type_asset_value_3_key.type_asset_value_3_key.deploy({ as: alice });
    await type_asset_value_3_key.type_asset_value_3_key.asset_put(v, { as: alice });
    const res = await type_asset_value_3_key.type_asset_value_3_key.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('key_hash', async () => {
    ...
    await type_asset_value_3_key_hash.type_asset_value_3_key_hash.deploy({ as: alice });
    await type_asset_value_3_key_hash.type_asset_value_3_key_hash.asset_put(v, { as: alice });
    const res = await type_asset_value_3_key_hash.type_asset_value_3_key_hash.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('nat', async () => {
    ...
    await type_asset_value_3_nat.type_asset_value_3_nat.deploy({ as: alice });
    await type_asset_value_3_nat.type_asset_value_3_nat.asset_put(v, { as: alice });
    const res = await type_asset_value_3_nat.type_asset_value_3_nat.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('rational', async () => {
    ...
    await type_asset_value_3_rational.type_asset_value_3_rational.deploy({ as: alice });
    await type_asset_value_3_rational.type_asset_value_3_rational.asset_put(v, { as: alice });
    const res = await type_asset_value_3_rational.type_asset_value_3_rational.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    await type_asset_value_3_sapling_transaction.type_asset_value_3_sapling_transaction.deploy({ as: alice });
    await type_asset_value_3_sapling_transaction.type_asset_value_3_sapling_transaction.asset_put(v, { as: alice });
    const res = await type_asset_value_3_sapling_transaction.type_asset_value_3_sapling_transaction.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });*/
  ...
  it('string', async () => {
    ...
    await type_asset_value_3_string.type_asset_value_3_string.deploy({ as: alice });
    await type_asset_value_3_string.type_asset_value_3_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_string.type_asset_value_3_string.get_my_asset();
  ...
  it('tez', async () => {
    ...
    await type_asset_value_3_tez.type_asset_value_3_tez.deploy({ as: alice });
    await type_asset_value_3_tez.type_asset_value_3_tez.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tez.type_asset_value_3_tez.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('tx_rollup_l2_address', async () => {
    ...
    await type_asset_value_3_tx_rollup_l2_address.type_asset_value_3_tx_rollup_l2_address.deploy({ as: alice });
    await type_asset_value_3_tx_rollup_l2_address.type_asset_value_3_tx_rollup_l2_address.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tx_rollup_l2_address.type_asset_value_3_tx_rollup_l2_address.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('unit', async () => {
    ...
    await type_asset_value_3_unit.type_asset_value_3_unit.deploy({ as: alice });
    await type_asset_value_3_unit.type_asset_value_3_unit.asset_put(v, { as: alice });
    const res = await type_asset_value_3_unit.type_asset_value_3_unit.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('list_nat', async () => {
    ...
    await type_asset_value_3_list_nat.type_asset_value_3_list_nat.deploy({ as: alice });
    await type_asset_value_3_list_nat.type_asset_value_3_list_nat.asset_put(v, { as: alice });
    const res = await type_asset_value_3_list_nat.type_asset_value_3_list_nat.get_my_asset();
  ...
  it('list_string', async () => {
    ...
    await type_asset_value_3_list_string.type_asset_value_3_list_string.deploy({ as: alice });
    await type_asset_value_3_list_string.type_asset_value_3_list_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_list_string.type_asset_value_3_list_string.get_my_asset();
  ...
  it('list_bool', async () => {
    ...
    await type_asset_value_3_list_bool.type_asset_value_3_list_bool.deploy({ as: alice });
    await type_asset_value_3_list_bool.type_asset_value_3_list_bool.asset_put(v, { as: alice });
    const res = await type_asset_value_3_list_bool.type_asset_value_3_list_bool.get_my_asset();
  ...
  it('map_nat_string', async () => {
    ...
    await type_asset_value_3_map_nat_string.type_asset_value_3_map_nat_string.deploy({ as: alice });
    await type_asset_value_3_map_nat_string.type_asset_value_3_map_nat_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_map_nat_string.type_asset_value_3_map_nat_string.get_my_asset();
  ...
  it('option_nat', async () => {
    ...
    await type_asset_value_3_option_nat.type_asset_value_3_option_nat.deploy({ as: alice });
    await type_asset_value_3_option_nat.type_asset_value_3_option_nat.asset_put(v, { as: alice });
    const res = await type_asset_value_3_option_nat.type_asset_value_3_option_nat.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('option_string', async () => {
    ...
    await type_asset_value_3_option_string.type_asset_value_3_option_string.deploy({ as: alice });
    await type_asset_value_3_option_string.type_asset_value_3_option_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_option_string.type_asset_value_3_option_string.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('option_bool', async () => {
    ...
    await type_asset_value_3_option_bool.type_asset_value_3_option_bool.deploy({ as: alice });
    await type_asset_value_3_option_bool.type_asset_value_3_option_bool.asset_put(v, { as: alice });
    const res = await type_asset_value_3_option_bool.type_asset_value_3_option_bool.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('set_nat', async () => {
    ...
    await type_asset_value_3_set_nat.type_asset_value_3_set_nat.deploy({ as: alice });
    await type_asset_value_3_set_nat.type_asset_value_3_set_nat.asset_put(v, { as: alice });
    const res = await type_asset_value_3_set_nat.type_asset_value_3_set_nat.get_my_asset();
  ...
  it('set_string', async () => {
    ...
    await type_asset_value_3_set_string.type_asset_value_3_set_string.deploy({ as: alice });
    await type_asset_value_3_set_string.type_asset_value_3_set_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_set_string.type_asset_value_3_set_string.get_my_asset();
  ...
  it('set_bool', async () => {
    ...
    await type_asset_value_3_set_bool.type_asset_value_3_set_bool.deploy({ as: alice });
    await type_asset_value_3_set_bool.type_asset_value_3_set_bool.asset_put(v, { as: alice });
    const res = await type_asset_value_3_set_bool.type_asset_value_3_set_bool.get_my_asset();
  ...
  it('tuple_nat_string', async () => {
    ...
    await type_asset_value_3_tuple_nat_string.type_asset_value_3_tuple_nat_string.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string.type_asset_value_3_tuple_nat_string.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string.type_asset_value_3_tuple_nat_string.get_my_asset();
  ...
  it('tuple_nat_string_bytes', async () => {
    ...
    await type_asset_value_3_tuple_nat_string_bytes.type_asset_value_3_tuple_nat_string_bytes.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string_bytes.type_asset_value_3_tuple_nat_string_bytes.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string_bytes.type_asset_value_3_tuple_nat_string_bytes.get_my_asset();
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    await type_asset_value_3_tuple_nat_string_bytes_bool.type_asset_value_3_tuple_nat_string_bytes_bool.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string_bytes_bool.type_asset_value_3_tuple_nat_string_bytes_bool.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string_bytes_bool.type_asset_value_3_tuple_nat_string_bytes_bool.get_my_asset();
  ...
  it('tuple_nat_string_bytes_rev', async () => {
    const v : [[Nat, string], Bytes] = [[new Nat(2), "toto"], new Bytes("ff")];
    await type_asset_value_3_tuple_nat_string_bytes_rev.type_asset_value_3_tuple_nat_string_bytes_rev.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string_bytes_rev.type_asset_value_3_tuple_nat_string_bytes_rev.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string_bytes_rev.type_asset_value_3_tuple_nat_string_bytes_rev.get_my_asset();
  ...
  it('tuple_nat_string_bytes_bool_rev', async () => {
    const v : [[[Nat, string], Bytes], boolean] = [[[new Nat(2), "toto"], new Bytes("ff")], true];
    await type_asset_value_3_tuple_nat_string_bytes_bool_rev.type_asset_value_3_tuple_nat_string_bytes_bool_rev.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string_bytes_bool_rev.type_asset_value_3_tuple_nat_string_bytes_bool_rev.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string_bytes_bool_rev.type_asset_value_3_tuple_nat_string_bytes_bool_rev.get_my_asset();
  ...
  it('tuple_nat_string_bytes_bool_custom', async () => {
    const v : [Nat, [string, Bytes], boolean] = [new Nat(2), ["toto", new Bytes("ff")], true];
    await type_asset_value_3_tuple_nat_string_bytes_bool_custom.type_asset_value_3_tuple_nat_string_bytes_bool_custom.deploy({ as: alice });
    await type_asset_value_3_tuple_nat_string_bytes_bool_custom.type_asset_value_3_tuple_nat_string_bytes_bool_custom.asset_put(v, { as: alice });
    const res = await type_asset_value_3_tuple_nat_string_bytes_bool_custom.type_asset_value_3_tuple_nat_string_bytes_bool_custom.get_my_asset();
  ...
  it('record_1_field', async () => {
    const v : type_asset_value_3_record_1_field.r_record = new type_asset_value_3_record_1_field.r_record(new Nat(2));
    await type_asset_value_3_record_1_field.type_asset_value_3_record_1_field.deploy({ as: alice });
    await type_asset_value_3_record_1_field.type_asset_value_3_record_1_field.asset_put(v, { as: alice });
    const res = await type_asset_value_3_record_1_field.type_asset_value_3_record_1_field.get_my_asset();
    assert(1 == res.length && v.equals(res[0][1].v), "Invalid Value")
  });
  ...
  it('record_complex', async () => {
    const v : type_asset_value_3_record_complex.r_record = new type_asset_value_3_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date("2022-12-31T23:59:59Z"), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] );
