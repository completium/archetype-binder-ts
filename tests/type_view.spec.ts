...
describe('Type view', async () => {
  ...
  it('address', async () => {
    ...
    const res = await type_view_address.type_view_address.view_get_value({ as: alice });
  ...
  it('bls12_381_fr', async () => {
    ...
    const res = await type_view_bls12_381_fr.type_view_bls12_381_fr.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g1', async () => {
    ...
    const res = await type_view_bls12_381_g1.type_view_bls12_381_g1.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    const res = await type_view_bls12_381_g2.type_view_bls12_381_g2.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bool', async () => {
    ...
    const res = await type_view_bool.type_view_bool.view_get_value({ as: alice });
  ...
  it('bytes', async () => {
    ...
    const res = await type_view_bytes.type_view_bytes.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('chain_id', async () => {
    ...
    const res = await type_view_chain_id.type_view_chain_id.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('chest', async () => {
    ...
    const res = await type_view_chest.type_view_chest.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    const res = await type_view_chest_key.type_view_chest_key.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('date', async () => {
    ...
    const res = await type_view_date.type_view_date.view_get_value({ as: alice });
  ...
  it('duration', async () => {
    ...
    const res = await type_view_duration.type_view_duration.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('int', async () => {
    ...
    const res = await type_view_int.type_view_int.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key', async () => {
    ...
    const res = await type_view_key.type_view_key.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key_hash', async () => {
    ...
    const res = await type_view_key_hash.type_view_key_hash.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('nat', async () => {
    ...
    const res = await type_view_nat.type_view_nat.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('rational', async () => {
    ...
    const res = await type_view_rational.type_view_rational.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    const res = await type_view_sapling_transaction.type_view_sapling_transaction.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('string', async () => {
    ...
    const res = await type_view_string.type_view_string.view_get_value({ as: alice });
  ...
  it('tez', async () => {
    ...
    const res = await type_view_tez.type_view_tez.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('unit', async () => {
    ...
    const res = await type_view_unit.type_view_unit.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('list_nat', async () => {
    ...
    const res = await type_view_list_nat.type_view_list_nat.view_get_value({ as: alice });
  ...
  it('list_string', async () => {
    ...
    const res = await type_view_list_string.type_view_list_string.view_get_value({ as: alice });
  ...
  it('list_bool', async () => {
    ...
    const res = await type_view_list_bool.type_view_list_bool.view_get_value({ as: alice });
  ...
  it('map_nat_string', async () => {
    ...
    const res = await type_view_map_nat_string.type_view_map_nat_string.view_get_value({ as: alice });
  ...
  it('option_nat', async () => {
    ...
    const res = await type_view_option_nat.type_view_option_nat.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_string', async () => {
    ...
    const res = await type_view_option_string.type_view_option_string.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_bool', async () => {
    ...
    const res = await type_view_option_bool.type_view_option_bool.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('or_nat_string', async () => {
    ...
    const res = await type_view_or_nat_string.type_view_or_nat_string.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('set_nat', async () => {
    ...
    const res = await type_view_set_nat.type_view_set_nat.view_get_value({ as: alice });
  ...
  it('set_string', async () => {
    ...
    const res = await type_view_set_string.type_view_set_string.view_get_value({ as: alice });
  ...
  it('set_bool', async () => {
    ...
    const res = await type_view_set_bool.type_view_set_bool.view_get_value({ as: alice });
  ...
  it('tuple_nat_string', async () => {
    ...
    const res = await type_view_tuple_nat_string.type_view_tuple_nat_string.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes', async () => {
    ...
    const res = await type_view_tuple_nat_string_bytes.type_view_tuple_nat_string_bytes.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    const res = await type_view_tuple_nat_string_bytes_bool.type_view_tuple_nat_string_bytes_bool.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_rev', async () => {
    ...
    const res = await type_view_tuple_nat_string_bytes_rev.type_view_tuple_nat_string_bytes_rev.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool_rev', async () => {
    ...
    const res = await type_view_tuple_nat_string_bytes_bool_rev.type_view_tuple_nat_string_bytes_bool_rev.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool_custom', async () => {
    ...
    const res = await type_view_tuple_nat_string_bytes_bool_custom.type_view_tuple_nat_string_bytes_bool_custom.view_get_value({ as: alice });
  ...
  it('record_2_fields', async () => {
    ...
    const res = await type_view_record_2_fields.type_view_record_2_fields.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('record_3_fields', async () => {
    ...
    const res = await type_view_record_3_fields.type_view_record_3_fields.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('record_4_fields', async () => {
    ...
    const res = await type_view_record_4_fields.type_view_record_4_fields.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('record_4_fields_custom', async () => {
    ...
    const res = await type_view_record_4_fields_custom.type_view_record_4_fields_custom.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
