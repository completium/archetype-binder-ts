...
import { type_view_address } from './contracts/bindings/type_view_address'
import { type_view_bls12_381_fr } from './contracts/bindings/type_view_bls12_381_fr'
import { type_view_bls12_381_g1 } from './contracts/bindings/type_view_bls12_381_g1'
import { type_view_bls12_381_g2 } from './contracts/bindings/type_view_bls12_381_g2'
import { type_view_bool } from './contracts/bindings/type_view_bool'
import { type_view_bytes } from './contracts/bindings/type_view_bytes'
import { type_view_chain_id } from './contracts/bindings/type_view_chain_id'
//import { type_view_chest } from './contracts/bindings/type_view_chest'
//import { type_view_chest_key } from './contracts/bindings/type_view_chest_key'
import { type_view_date } from './contracts/bindings/type_view_date'
import { type_view_duration } from './contracts/bindings/type_view_duration'
import { type_view_int } from './contracts/bindings/type_view_int'
import { type_view_key } from './contracts/bindings/type_view_key'
import { type_view_key_hash } from './contracts/bindings/type_view_key_hash'
import { type_view_nat } from './contracts/bindings/type_view_nat'
import { type_view_rational } from './contracts/bindings/type_view_rational'
//import { type_view_sapling_transaction } from './contracts/bindings/type_view_sapling_transaction'
//import { type_view_signature } from './contracts/bindings/type_view_signature'
import { type_view_string } from './contracts/bindings/type_view_string'
import { type_view_tez } from './contracts/bindings/type_view_tez'
import { type_view_unit } from './contracts/bindings/type_view_unit'
import { type_view_list_nat } from './contracts/bindings/type_view_list_nat'
import { type_view_list_string } from './contracts/bindings/type_view_list_string'
import { type_view_list_bool } from './contracts/bindings/type_view_list_bool'
import { type_view_map_nat_string } from './contracts/bindings/type_view_map_nat_string'
import { type_view_option_nat } from './contracts/bindings/type_view_option_nat'
import { type_view_option_string } from './contracts/bindings/type_view_option_string'
import { type_view_option_bool } from './contracts/bindings/type_view_option_bool'
//import { type_view_or_nat_string } from './contracts/bindings/type_view_or_nat_string'
import { type_view_set_nat } from './contracts/bindings/type_view_set_nat'
import { type_view_set_string } from './contracts/bindings/type_view_set_string'
import { type_view_set_bool } from './contracts/bindings/type_view_set_bool'
import { type_view_tuple_nat_string } from './contracts/bindings/type_view_tuple_nat_string'
import { type_view_tuple_nat_string_bytes } from './contracts/bindings/type_view_tuple_nat_string_bytes'
import { type_view_tuple_nat_string_bytes_bool } from './contracts/bindings/type_view_tuple_nat_string_bytes_bool'
import { type_view_tuple_nat_string_bytes_rev } from './contracts/bindings/type_view_tuple_nat_string_bytes_rev'
import { type_view_tuple_nat_string_bytes_bool_rev } from './contracts/bindings/type_view_tuple_nat_string_bytes_bool_rev'
import { type_view_tuple_nat_string_bytes_bool_custom } from './contracts/bindings/type_view_tuple_nat_string_bytes_bool_custom'
...
describe('Type view', async () => {
  ...
  it('address', async () => {
    ...
    await type_view_address.deploy({ as: alice });
    const res = await type_view_address.view_get_value({ as: alice });
  ...
  it('bls12_381_fr', async () => {
    ...
    await type_view_bls12_381_fr.deploy({ as: alice });
    const res = await type_view_bls12_381_fr.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g1', async () => {
    ...
    await type_view_bls12_381_g1.deploy({ as: alice });
    const res = await type_view_bls12_381_g1.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    await type_view_bls12_381_g2.deploy({ as: alice });
    const res = await type_view_bls12_381_g2.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bool', async () => {
    ...
    await type_view_bool.deploy({ as: alice });
    const res = await type_view_bool.view_get_value({ as: alice });
  ...
  it('bytes', async () => {
    ...
    await type_view_bytes.deploy({ as: alice });
    const res = await type_view_bytes.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('chain_id', async () => {
    ...
    await type_view_chain_id.deploy({ as: alice });
    const res = await type_view_chain_id.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('chest', async () => {
    ...
    await type_view_chest.deploy({ as: alice });
    const res = await type_view_chest.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    await type_view_chest_key.deploy({ as: alice });
    const res = await type_view_chest_key.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('date', async () => {
    ...
    await type_view_date.deploy({ as: alice });
    const res = await type_view_date.view_get_value({ as: alice });
  ...
  it('duration', async () => {
    ...
    await type_view_duration.deploy({ as: alice });
    const res = await type_view_duration.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('int', async () => {
    ...
    await type_view_int.deploy({ as: alice });
    const res = await type_view_int.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key', async () => {
    ...
    await type_view_key.deploy({ as: alice });
    const res = await type_view_key.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key_hash', async () => {
    ...
    await type_view_key_hash.deploy({ as: alice });
    const res = await type_view_key_hash.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('nat', async () => {
    ...
    await type_view_nat.deploy({ as: alice });
    const res = await type_view_nat.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('rational', async () => {
    ...
    await type_view_rational.deploy({ as: alice });
    const res = await type_view_rational.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    await type_view_sapling_transaction.deploy({ as: alice });
    const res = await type_view_sapling_transaction.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('signature', async () => {
    ...
    await type_view_signature.deploy({ as: alice });
    const res = await type_view_signature.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('string', async () => {
    ...
    await type_view_string.deploy({ as: alice });
    const res = await type_view_string.view_get_value({ as: alice });
  ...
  it('tez', async () => {
    ...
    await type_view_tez.deploy({ as: alice });
    const res = await type_view_tez.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('unit', async () => {
    ...
    await type_view_unit.deploy({ as: alice });
    const res = await type_view_unit.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('list_nat', async () => {
    ...
    await type_view_list_nat.deploy({ as: alice });
    const res = await type_view_list_nat.view_get_value({ as: alice });
  ...
  it('list_string', async () => {
    ...
    await type_view_list_string.deploy({ as: alice });
    const res = await type_view_list_string.view_get_value({ as: alice });
  ...
  it('list_bool', async () => {
    ...
    await type_view_list_bool.deploy({ as: alice });
    const res = await type_view_list_bool.view_get_value({ as: alice });
  ...
  it('map_nat_string', async () => {
    ...
    await type_view_map_nat_string.deploy({ as: alice });
    const res = await type_view_map_nat_string.view_get_value({ as: alice });
  ...
  it('option_nat', async () => {
    ...
    await type_view_option_nat.deploy({ as: alice });
    const res = await type_view_option_nat.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_string', async () => {
    ...
    await type_view_option_string.deploy({ as: alice });
    const res = await type_view_option_string.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_bool', async () => {
    ...
    await type_view_option_bool.deploy({ as: alice });
    const res = await type_view_option_bool.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('or_nat_string', async () => {
    ...
    await type_view_or_nat_string.deploy({ as: alice });
    const res = await type_view_or_nat_string.view_get_value({ as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('set_nat', async () => {
    ...
    await type_view_set_nat.deploy({ as: alice });
    const res = await type_view_set_nat.view_get_value({ as: alice });
  ...
  it('set_string', async () => {
    ...
    await type_view_set_string.deploy({ as: alice });
    const res = await type_view_set_string.view_get_value({ as: alice });
  ...
  it('set_bool', async () => {
    ...
    await type_view_set_bool.deploy({ as: alice });
    const res = await type_view_set_bool.view_get_value({ as: alice });
  ...
  it('tuple_nat_string', async () => {
    ...
    await type_view_tuple_nat_string.deploy({ as: alice });
    const res = await type_view_tuple_nat_string.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes', async () => {
    ...
    await type_view_tuple_nat_string_bytes.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    await type_view_tuple_nat_string_bytes_bool.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_rev', async () => {
    const v : [[Nat, string], Bytes] = [[new Nat(2), "toto"], new Bytes("ff")];
    await type_view_tuple_nat_string_bytes_rev.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_rev.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool_rev', async () => {
    const v : [[[Nat, string], Bytes], boolean] = [[[new Nat(2), "toto"], new Bytes("ff")], true];
    await type_view_tuple_nat_string_bytes_bool_rev.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool_rev.view_get_value({ as: alice });
  ...
  it('tuple_nat_string_bytes_bool_custom', async () => {
    const v : [Nat, [string, Bytes], boolean] = [new Nat(2), ["toto", new Bytes("ff")], true];
    await type_view_tuple_nat_string_bytes_bool_custom.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool_custom.view_get_value({ as: alice });
