...
import * as type_view_bls12_381_fr from './contracts/bindings/type_view_bls12_381_fr'
import * as type_view_bls12_381_g1 from './contracts/bindings/type_view_bls12_381_g1'
import * as type_view_bls12_381_g2 from './contracts/bindings/type_view_bls12_381_g2'
import * as type_view_bool from './contracts/bindings/type_view_bool'
import * as type_view_bytes from './contracts/bindings/type_view_bytes'
import * as type_view_chain_id from './contracts/bindings/type_view_chain_id'
//import * as type_view_chest from './contracts/bindings/type_view_chest'
//import * as type_view_chest_key from './contracts/bindings/type_view_chest_key'
import * as type_view_date from './contracts/bindings/type_view_date'
import * as type_view_duration from './contracts/bindings/type_view_duration'
import * as type_view_int from './contracts/bindings/type_view_int'
import * as type_view_key from './contracts/bindings/type_view_key'
import * as type_view_key_hash from './contracts/bindings/type_view_key_hash'
import * as type_view_nat from './contracts/bindings/type_view_nat'
import * as type_view_rational from './contracts/bindings/type_view_rational'
//import * as type_view_sapling_transaction from './contracts/bindings/type_view_sapling_transaction'
...
import * as type_view_list_bool from './contracts/bindings/type_view_list_bool'
import * as type_view_map_nat_string from './contracts/bindings/type_view_map_nat_string'
import * as type_view_option_nat from './contracts/bindings/type_view_option_nat'
import * as type_view_option_string from './contracts/bindings/type_view_option_string'
import * as type_view_option_bool from './contracts/bindings/type_view_option_bool'
import * as type_view_or_nat_string from './contracts/bindings/type_view_or_nat_string'
import * as type_view_set_nat from './contracts/bindings/type_view_set_nat'
import * as type_view_set_string from './contracts/bindings/type_view_set_string'
import * as type_view_set_bool from './contracts/bindings/type_view_set_bool'
import * as type_view_tuple_nat_string from './contracts/bindings/type_view_tuple_nat_string'
import * as type_view_tuple_nat_string_bytes from './contracts/bindings/type_view_tuple_nat_string_bytes'
import * as type_view_tuple_nat_string_bytes_bool from './contracts/bindings/type_view_tuple_nat_string_bytes_bool'
import * as type_view_tuple_nat_string_bytes_rev from './contracts/bindings/type_view_tuple_nat_string_bytes_rev'
...
describe('Type view', () => {
  ...
  it('address', async () => {
    ...
    await type_view_address.type_view_address.deploy({ as: alice });
    const res = await type_view_address.type_view_address.view_get_value(v, { as: alice });
  ...
  it('bls12_381_fr', async () => {
    ...
    await type_view_bls12_381_fr.type_view_bls12_381_fr.deploy({ as: alice });
    const res = await type_view_bls12_381_fr.type_view_bls12_381_fr.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g1', async () => {
    ...
    await type_view_bls12_381_g1.type_view_bls12_381_g1.deploy({ as: alice });
    const res = await type_view_bls12_381_g1.type_view_bls12_381_g1.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bls12_381_g2', async () => {
    ...
    await type_view_bls12_381_g2.type_view_bls12_381_g2.deploy({ as: alice });
    const res = await type_view_bls12_381_g2.type_view_bls12_381_g2.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('bool', async () => {
    ...
    await type_view_bool.type_view_bool.deploy({ as: alice });
    const res = await type_view_bool.type_view_bool.view_get_value(v, { as: alice });
  ...
  it('bytes', async () => {
    ...
    await type_view_bytes.type_view_bytes.deploy({ as: alice });
    const res = await type_view_bytes.type_view_bytes.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('chain_id', async () => {
    ...
    await type_view_chain_id.type_view_chain_id.deploy({ as: alice });
    const res = await type_view_chain_id.type_view_chain_id.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('chest', async () => {
    ...
    await type_view_chest.type_view_chest.deploy({ as: alice });
    const res = await type_view_chest.type_view_chest.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  /*it('chest_key', async () => {
    ...
    await type_view_chest_key.type_view_chest_key.deploy({ as: alice });
    const res = await type_view_chest_key.type_view_chest_key.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('date', async () => {
    ...
    await type_view_date.type_view_date.deploy({ as: alice });
    const res = await type_view_date.type_view_date.view_get_value(v, { as: alice });
  ...
  it('duration', async () => {
    ...
    await type_view_duration.type_view_duration.deploy({ as: alice });
    const res = await type_view_duration.type_view_duration.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('int', async () => {
    ...
    await type_view_int.type_view_int.deploy({ as: alice });
    const res = await type_view_int.type_view_int.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key', async () => {
    ...
    await type_view_key.type_view_key.deploy({ as: alice });
    const res = await type_view_key.type_view_key.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('key_hash', async () => {
    ...
    await type_view_key_hash.type_view_key_hash.deploy({ as: alice });
    const res = await type_view_key_hash.type_view_key_hash.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('nat', async () => {
    ...
    await type_view_nat.type_view_nat.deploy({ as: alice });
    const res = await type_view_nat.type_view_nat.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('rational', async () => {
    ...
    await type_view_rational.type_view_rational.deploy({ as: alice });
    const res = await type_view_rational.type_view_rational.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  /*it('sapling_transaction', async () => {
    ...
    await type_view_sapling_transaction.type_view_sapling_transaction.deploy({ as: alice });
    const res = await type_view_sapling_transaction.type_view_sapling_transaction.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });*/
  ...
  it('signature', async () => {
    ...
    const res = await type_view_signature.type_view_signature.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('string', async () => {
    ...
    await type_view_string.type_view_string.deploy({ as: alice });
    const res = await type_view_string.type_view_string.view_get_value(v, { as: alice });
  ...
  it('unit', async () => {
    ...
    await type_view_unit.type_view_unit.deploy({ as: alice });
    const res = await type_view_unit.type_view_unit.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('list_nat', async () => {
    ...
    await type_view_list_nat.type_view_list_nat.deploy({ as: alice });
    const res = await type_view_list_nat.type_view_list_nat.view_get_value(v, { as: alice });
  ...
  it('list_string', async () => {
    ...
    await type_view_list_string.type_view_list_string.deploy({ as: alice });
    const res = await type_view_list_string.type_view_list_string.view_get_value(v, { as: alice });
  ...
  it('list_bool', async () => {
    ...
    await type_view_list_bool.type_view_list_bool.deploy({ as: alice });
    const res = await type_view_list_bool.type_view_list_bool.view_get_value(v, { as: alice });
  ...
  it('map_nat_string', async () => {
    ...
    await type_view_map_nat_string.type_view_map_nat_string.deploy({ as: alice });
    const res = await type_view_map_nat_string.type_view_map_nat_string.view_get_value(v, { as: alice });
  ...
  it('option_nat', async () => {
    ...
    await type_view_option_nat.type_view_option_nat.deploy({ as: alice });
    const res = await type_view_option_nat.type_view_option_nat.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_string', async () => {
    ...
    await type_view_option_string.type_view_option_string.deploy({ as: alice });
    const res = await type_view_option_string.type_view_option_string.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('option_bool', async () => {
    ...
    await type_view_option_bool.type_view_option_bool.deploy({ as: alice });
    const res = await type_view_option_bool.type_view_option_bool.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('or_nat_string', async () => {
    ...
    await type_view_or_nat_string.type_view_or_nat_string.deploy({ as: alice });
    const res = await type_view_or_nat_string.type_view_or_nat_string.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('set_nat', async () => {
    ...
    await type_view_set_nat.type_view_set_nat.deploy({ as: alice });
    const res = await type_view_set_nat.type_view_set_nat.view_get_value(v, { as: alice });
  ...
  it('set_string', async () => {
    ...
    await type_view_set_string.type_view_set_string.deploy({ as: alice });
    const res = await type_view_set_string.type_view_set_string.view_get_value(v, { as: alice });
  ...
  it('set_bool', async () => {
    ...
    await type_view_set_bool.type_view_set_bool.deploy({ as: alice });
    const res = await type_view_set_bool.type_view_set_bool.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string', async () => {
    ...
    await type_view_tuple_nat_string.type_view_tuple_nat_string.deploy({ as: alice });
    const res = await type_view_tuple_nat_string.type_view_tuple_nat_string.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string_bytes', async () => {
    ...
    await type_view_tuple_nat_string_bytes.type_view_tuple_nat_string_bytes.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes.type_view_tuple_nat_string_bytes.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string_bytes_bool', async () => {
    ...
    await type_view_tuple_nat_string_bytes_bool.type_view_tuple_nat_string_bytes_bool.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool.type_view_tuple_nat_string_bytes_bool.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string_bytes_rev', async () => {
    const v : [[Nat, string], Bytes] = [[new Nat(2), "toto"], new Bytes("ff")];
    await type_view_tuple_nat_string_bytes_rev.type_view_tuple_nat_string_bytes_rev.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_rev.type_view_tuple_nat_string_bytes_rev.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string_bytes_bool_rev', async () => {
    const v : [[[Nat, string], Bytes], boolean] = [[[new Nat(2), "toto"], new Bytes("ff")], true];
    await type_view_tuple_nat_string_bytes_bool_rev.type_view_tuple_nat_string_bytes_bool_rev.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool_rev.type_view_tuple_nat_string_bytes_bool_rev.view_get_value(v, { as: alice });
  ...
  it('tuple_nat_string_bytes_bool_custom', async () => {
    const v : [Nat, [string, Bytes], boolean] = [new Nat(2), ["toto", new Bytes("ff")], true];
    await type_view_tuple_nat_string_bytes_bool_custom.type_view_tuple_nat_string_bytes_bool_custom.deploy({ as: alice });
    const res = await type_view_tuple_nat_string_bytes_bool_custom.type_view_tuple_nat_string_bytes_bool_custom.view_get_value(v, { as: alice });
  ...
  it('enum_simple', async () => {
    const v : type_view_enum_simple.e_enum = new type_view_enum_simple.e_2();
  ...
  it('record_2_fields', async () => {
    const v : type_view_record_2_fields.r_record = new type_view_record_2_fields.r_record(new Nat(2), "mystr");
    await type_view_record_2_fields.type_view_record_2_fields.deploy({ as: alice });
    const res = await type_view_record_2_fields.type_view_record_2_fields.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });

  // record_3_fields
  it('record_3_fields', async () => {
    const v : type_view_record_3_fields.r_record = new type_view_record_3_fields.r_record(new Nat(2), "mystr", new Bytes("02"));
    await type_view_record_3_fields.type_view_record_3_fields.deploy({ as: alice });
    const res = await type_view_record_3_fields.type_view_record_3_fields.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });

  // record_4_fields
  it('record_4_fields', async () => {
    const v : type_view_record_4_fields.r_record = new type_view_record_4_fields.r_record(new Nat(2), "mystr", new Bytes("02"), true);
    await type_view_record_4_fields.type_view_record_4_fields.deploy({ as: alice });
    const res = await type_view_record_4_fields.type_view_record_4_fields.view_get_value(v, { as: alice });
    assert(v.equals(res), "Invalid Value")
  });
  ...
  it('record_complex', async () => {
    const v : type_view_record_complex.r_record = new type_view_record_complex.r_record(new Nat(2), new Int(3), new Tez(1), new Rational(0.1), true, new Bytes("02"), "mystr", new Date("2022-12-31T23:59:59Z"), new Duration("1m"), alice.get_address(), Option.Some(new Nat(4)), ["a", "b", "c"], [["astring", new Nat(5), new Int(6)]] );
