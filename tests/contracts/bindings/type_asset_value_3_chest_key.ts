...
export class Type_asset_value_3_chest_key {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_chest_key.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_chest_key = new Type_asset_value_3_chest_key();
