...
export class Type_map_value_option_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_option_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_option_bool = new Type_map_value_option_bool();
