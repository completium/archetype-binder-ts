...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "nat", annots: [] }, { prim: "address", annots: [] }], annots: [] };
const set_value_arg_to_mich = (i: att.Address): att.Micheline => {
    return i.to_mich();
}
export class Type_or_right_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_right_address.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_or_right_address = new Type_or_right_address();
