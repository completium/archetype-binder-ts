...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: ["%s"] }, { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: ["%v"] }], annots: [] }], annots: [] };
...
export class Type_asset_value_3_map_nat_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_map_nat_string.arl", {}, params)).address;
        this.address = address;
    }
