...
export class Type_asset_key_2_big_map_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_big_map_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_big_map_nat = new Type_asset_key_2_big_map_nat();
