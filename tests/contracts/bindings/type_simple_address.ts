...
export class Type_simple_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_address.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_address = new Type_simple_address();
