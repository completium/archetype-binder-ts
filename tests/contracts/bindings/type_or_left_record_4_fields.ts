...
export class Type_or_left_record_4_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const res = await ex.deploy("./tests/contracts/type_or_left_record_4_fields.arl", {}, params);
...
export const type_or_left_record_4_fields = new Type_or_left_record_4_fields();
