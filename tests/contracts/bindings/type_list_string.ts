...
export class Type_list_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_string.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_list_string = new Type_list_string();
