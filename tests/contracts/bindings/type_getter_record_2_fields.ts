...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "string", annots: ["%f_b"] }], annots: [] };
...
export class Type_getter_record_2_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_getter_record_2_fields.arl", {}, params)).address;
        this.address = address;
...
export const type_getter_record_2_fields = new Type_getter_record_2_fields();
