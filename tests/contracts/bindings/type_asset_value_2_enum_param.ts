...
export class Type_asset_value_2_enum_param {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_enum_param.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_2_enum_param = new Type_asset_value_2_enum_param();
