...
export class Type_set_unit {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_set_unit.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: Array<att.Unit>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
