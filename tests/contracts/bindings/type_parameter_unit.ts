...
export class Type_asset_parameter_unit {
    ...
    async deploy(res: att.Unit, params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_unit.arl", {
...
export const type_asset_parameter_unit = new Type_asset_parameter_unit();
