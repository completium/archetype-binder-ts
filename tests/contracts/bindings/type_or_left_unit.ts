...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "unit", annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_or_left_unit {
    ...
    async get_res(): Promise<att.Or<att.Unit, att.Nat>> {
        if (this.address != undefined) {
            ...
            return att.mich_to_or(storage, x => { return att.unit_to_mich(); }, x => { return att.mich_to_nat(x); });
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
