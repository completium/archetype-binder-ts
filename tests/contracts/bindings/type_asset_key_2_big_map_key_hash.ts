...
export class Type_asset_key_2_big_map_key_hash {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_big_map_key_hash.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_big_map_key_hash = new Type_asset_key_2_big_map_key_hash();
