...
export class Type_map_value_record_complex {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_record_complex.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_record_complex = new Type_map_value_record_complex();
