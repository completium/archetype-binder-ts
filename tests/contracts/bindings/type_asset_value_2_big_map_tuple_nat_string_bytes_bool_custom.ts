...
export class Type_asset_value_2_big_map_tuple_nat_string_bytes_bool_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_big_map_tuple_nat_string_bytes_bool_custom.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        att.Nat,
...
export const type_asset_value_2_big_map_tuple_nat_string_bytes_bool_custom = new Type_asset_value_2_big_map_tuple_nat_string_bytes_bool_custom();
