...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "bls12_381_g2", annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_or_left_bls12_381_g2 {
    ...
    async get_res(): Promise<att.Or<att.Bls12_381_g2, att.Nat>> {
        if (this.address != undefined) {
            ...
            return att.mich_to_or(storage, x => { return att.mich_to_bls12_381_g2(x); }, x => { return att.mich_to_nat(x); });
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
