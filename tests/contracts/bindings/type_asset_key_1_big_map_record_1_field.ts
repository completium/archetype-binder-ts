...
export class Type_asset_key_1_big_map_record_1_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_1_big_map_record_1_field.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_my_asset_value(key: r_record): Promise<string | undefined> {
        if (this.address != undefined) {
...
export const type_asset_key_1_big_map_record_1_field = new Type_asset_key_1_big_map_record_1_field();
