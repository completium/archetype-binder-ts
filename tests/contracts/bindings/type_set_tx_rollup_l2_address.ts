...
export class Type_set_tx_rollup_l2_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_set_tx_rollup_l2_address.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: Array<att.Tx_rollup_l2_address>, params: Partial<ex.Parameters>): Promise<any> {
...
export const type_set_tx_rollup_l2_address = new Type_set_tx_rollup_l2_address();
