...
export const storage_type: att.MichelineType = { prim: "set", args: [{ prim: "pair", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "bytes", annots: [] }], annots: [] }], annots: [] };
...
export class Type_set_tuple_nat_string_bytes_rev {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_set_tuple_nat_string_bytes_rev.arl", {}, params)).address;
        this.address = address;
    }
