...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "or", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_map_key_or_nat_string {
    ...
    async get_res(): Promise<Array<[
        ...
        if (this.address != undefined) {
            ...
            return att.mich_to_map(storage, (x, y) => [att.mich_to_or(x, x => { return att.mich_to_nat(x); }, x => { return att.mich_to_string(x); }), att.mich_to_nat(y)]);
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
