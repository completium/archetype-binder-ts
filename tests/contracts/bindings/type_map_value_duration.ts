...
export class Type_map_value_duration {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_duration.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_duration = new Type_map_value_duration();
