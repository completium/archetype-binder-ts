...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%n"] }, { prim: "pair", args: [{ prim: "string", annots: ["%v"] }, { prim: "string", annots: ["%s"] }], annots: [] }], annots: [] };
...
export class Type_record_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_record_string.arl", {}, params)).address;
        this.address = address;
    }
