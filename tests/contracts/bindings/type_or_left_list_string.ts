...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "list", args: [{ prim: "string", annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_or_left_list_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_left_list_string.arl", {}, params)).address;
        this.address = address;
    }
