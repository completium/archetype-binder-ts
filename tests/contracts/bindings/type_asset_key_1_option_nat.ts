...
export const my_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.option_annot_to_mich_type(att.prim_annot_to_mich_type("nat", []), []), att.prim_annot_to_mich_type("string", []), []);
