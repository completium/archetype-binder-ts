...
export class Type_list_enum_param {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_enum_param.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_list_enum_param = new Type_list_enum_param();
