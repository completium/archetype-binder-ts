...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "pair", args: [{ prim: "bytes", annots: ["%f_c"] }, { prim: "bool", annots: ["%f_d"] }], annots: [] }], annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] };
...
export class Type_asset_key_1_record_4_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_1_record_4_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_1_record_4_fields = new Type_asset_key_1_record_4_fields();
