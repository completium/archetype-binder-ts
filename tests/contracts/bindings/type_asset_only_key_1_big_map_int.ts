...
export class Type_asset_only_key_1_big_map_int {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_1_big_map_int.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_my_asset_value(key: att.Int): Promise<my_asset_value | undefined> {
        if (this.address != undefined) {
...
export const type_asset_only_key_1_big_map_int = new Type_asset_only_key_1_big_map_int();
