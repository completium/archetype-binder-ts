...
export class Type_asset_value_3_big_map_signature {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_big_map_signature.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_big_map_signature = new Type_asset_value_3_big_map_signature();
