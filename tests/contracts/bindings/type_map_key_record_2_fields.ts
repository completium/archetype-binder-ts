...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "string", annots: ["%f_b"] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_map_key_record_2_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_key_record_2_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_key_record_2_fields = new Type_map_key_record_2_fields();
