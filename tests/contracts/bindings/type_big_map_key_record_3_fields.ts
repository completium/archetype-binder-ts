...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "bytes", annots: ["%f_c"] }], annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_big_map_key_record_3_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_key_record_3_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_big_map_key_record_3_fields = new Type_big_map_key_record_3_fields();
