...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "pair", args: [{ prim: "string", annots: [] }, { prim: "bytes", annots: [] }], annots: [] }, { prim: "bool", annots: [] }], annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_tuple_nat_string_bytes_bool_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_tuple_nat_string_bytes_bool_custom.arl", {}, params)).address;
        this.address = address;
    }
