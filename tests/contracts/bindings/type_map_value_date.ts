...
export class Type_map_value_date {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_date.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_date = new Type_map_value_date();
