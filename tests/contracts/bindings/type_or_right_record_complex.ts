...
export class Type_or_right_record_complex {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_right_record_complex.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_or_right_record_complex = new Type_or_right_record_complex();
