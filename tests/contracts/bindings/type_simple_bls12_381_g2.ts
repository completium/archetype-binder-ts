...
export const storage_type: att.MichelineType = { prim: "bls12_381_g2", annots: [] };
const set_value_arg_to_mich = (i: att.Bls12_381_g2): att.Micheline => {
    return i.to_mich();
}
export class Type_simple_bls12_381_g2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_bls12_381_g2.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_bls12_381_g2 = new Type_simple_bls12_381_g2();
