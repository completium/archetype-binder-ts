...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "set", args: [{ prim: "string", annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_set_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_set_string.arl", {}, params)).address;
        this.address = address;
    }
