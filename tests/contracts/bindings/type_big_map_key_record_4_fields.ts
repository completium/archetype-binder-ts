...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "pair", args: [{ prim: "bytes", annots: ["%f_c"] }, { prim: "bool", annots: ["%f_d"] }], annots: [] }], annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
