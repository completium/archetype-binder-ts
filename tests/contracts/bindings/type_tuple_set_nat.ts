...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "set", args: [{ prim: "nat", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] }], annots: [] };
