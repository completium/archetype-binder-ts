...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "pair", args: [{ prim: "int", annots: [] }, { prim: "nat", annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_rational {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_rational.arl", {}, params)).address;
        this.address = address;
    }
