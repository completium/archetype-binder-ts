...
export class Type_asset_key_1_big_map_int {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_1_big_map_int.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_1_big_map_int = new Type_asset_key_1_big_map_int();
