...
export class Type_simple_set_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_set_string.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_set_string = new Type_simple_set_string();
