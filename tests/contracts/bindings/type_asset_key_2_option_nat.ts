...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "option", args: [{ prim: "nat", annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] };
export class my_asset_key implements att.ArchetypeType {
    constructor(public k: att.Option<att.Nat>, public n: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.k.to_mich((x => { return x.to_mich(); })), this.n.to_mich()]);
    }
...
export const my_asset_key_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.option_annot_to_mich_type(att.prim_annot_to_mich_type("nat", []), ["%k"]),
...
export class Type_asset_key_2_option_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_option_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_option_nat = new Type_asset_key_2_option_nat();
