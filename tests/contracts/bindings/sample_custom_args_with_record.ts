...
export class Sample_custom_args_with_record {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/sample_custom_args_with_record.arl", {}, params)).address;
        this.address = address;
    }
...
export const sample_custom_args_with_record = new Sample_custom_args_with_record();
