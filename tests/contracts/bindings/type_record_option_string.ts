...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%n"] }, { prim: "pair", args: [{ prim: "option", args: [{ prim: "string", annots: [] }], annots: ["%v"] }, { prim: "string", annots: ["%s"] }], annots: [] }], annots: [] };
export class my_record implements att.ArchetypeType {
    constructor(public n: att.Nat, public v: att.Option<string>, public s: string) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.n.to_mich(), att.pair_to_mich([this.v.to_mich((x => { return att.string_to_mich(x); })), att.string_to_mich(this.s)])]);
    }
...
export class Type_record_option_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_record_option_string.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_record_option_string = new Type_record_option_string();
