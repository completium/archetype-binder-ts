...
export class Type_simple_tez {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_tez.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_tez = new Type_simple_tez();
