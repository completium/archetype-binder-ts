...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "nat", annots: [] }, { prim: "list", args: [{ prim: "bool", annots: [] }], annots: [] }], annots: [] };
...
export class Type_big_map_value_list_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_value_list_bool.arl", {}, params)).address;
        this.address = address;
    }
