...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "or", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] }], annots: [] };
    ...
    async get_res(): Promise<[
        ...
        if (this.address != undefined) {
            ...
            return (p => {
                ...
                return [att.mich_to_nat(p0.args[0]), att.mich_to_or(p0.args[1], x => { return att.mich_to_nat(x); }, x => { return att.mich_to_string(x); }), att.mich_to_string(p1.args[0])];
            })(storage);
        }
        throw new Error("Contract not initialised");
    }
