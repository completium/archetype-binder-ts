...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_map_key_tuple_nat_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_key_tuple_nat_string.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: [
        att.Nat,
