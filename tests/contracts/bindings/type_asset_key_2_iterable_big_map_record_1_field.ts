...
export class Type_asset_key_2_iterable_big_map_record_1_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_iterable_big_map_record_1_field.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_iterable_big_map_record_1_field = new Type_asset_key_2_iterable_big_map_record_1_field();
