...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: [] }, { prim: "pair", args: [{ prim: "bytes", annots: [] }, { prim: "bool", annots: [] }], annots: [] }], annots: [] }], annots: [] }], annots: [] };
...
export class Type_asset_value_2_tuple_nat_string_bytes_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_tuple_nat_string_bytes_bool.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        att.Nat,
...
export const type_asset_value_2_tuple_nat_string_bytes_bool = new Type_asset_value_2_tuple_nat_string_bytes_bool();
