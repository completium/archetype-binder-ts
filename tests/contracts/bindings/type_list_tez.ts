...
export class Type_list_tez {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_tez.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: Array<att.Tez>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
...
export const type_list_tez = new Type_list_tez();
