...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "nat", annots: [] }, { prim: "bls12_381_g2", annots: [] }], annots: [] };
const set_value_arg_to_mich = (i: att.Bls12_381_g2): att.Micheline => {
    return i.to_mich();
}
export class Type_or_right_bls12_381_g2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_right_bls12_381_g2.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_or_right_bls12_381_g2 = new Type_or_right_bls12_381_g2();
