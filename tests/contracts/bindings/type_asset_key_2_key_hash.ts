...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "key_hash", annots: [] }, { prim: "nat", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] };
...
export class Type_asset_key_2_key_hash {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_key_hash.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_key_hash = new Type_asset_key_2_key_hash();
