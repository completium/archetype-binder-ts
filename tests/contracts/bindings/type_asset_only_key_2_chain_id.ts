...
export class Type_asset_only_key_2_chain_id {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_2_chain_id.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_only_key_2_chain_id = new Type_asset_only_key_2_chain_id();
