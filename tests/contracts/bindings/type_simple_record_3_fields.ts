...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "bytes", annots: ["%f_c"] }], annots: [] }], annots: [] };
...
export class Type_simple_record_3_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_record_3_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_record_3_fields = new Type_simple_record_3_fields();
