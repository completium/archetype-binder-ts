...
export class Type_simple_unit {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_unit.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_unit = new Type_simple_unit();
