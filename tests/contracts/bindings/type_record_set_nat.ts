...
export class Type_record_set_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_record_set_nat.arl", {}, params);
        this.address = address;
    }
...
export const type_record_set_nat = new Type_record_set_nat();
