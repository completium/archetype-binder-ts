...
export class Type_set_enum_simple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_set_enum_simple.arl", {}, params);
        this.address = address;
    }
...
export const type_set_enum_simple = new Type_set_enum_simple();
