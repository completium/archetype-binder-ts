...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "pair", args: [{ prim: "pair", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "bytes", annots: [] }], annots: [] }, { prim: "bool", annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_tuple_nat_string_bytes_bool_rev {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_tuple_nat_string_bytes_bool_rev.arl", {}, params)).address;
        this.address = address;
    }
