...
export class Type_set_record_1_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_set_record_1_field.arl", {}, params);
        this.address = address;
    }
...
export const type_set_record_1_field = new Type_set_record_1_field();
