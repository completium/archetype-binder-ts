...
export class Type_asset_parameter_list_bool {
    ...
    async deploy(res: Array<boolean>, params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_list_bool.arl", {
...
export const type_asset_parameter_list_bool = new Type_asset_parameter_list_bool();
