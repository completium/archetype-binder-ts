...
export class Type_parameter_list_bool {
    ...
    async asset_add(i: Array<boolean>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
...
export const type_parameter_list_bool = new Type_parameter_list_bool();
