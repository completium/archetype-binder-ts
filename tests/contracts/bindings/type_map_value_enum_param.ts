...
export class Type_map_value_enum_param {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_enum_param.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_enum_param = new Type_map_value_enum_param();
