...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: ["%s"] }, { prim: "address", annots: ["%v"] }], annots: [] }], annots: [] };
...
export class Type_asset_value_3_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_address.arl", {}, params)).address;
        this.address = address;
    }
