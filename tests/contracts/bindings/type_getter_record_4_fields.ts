...
export class Type_getter_record_4_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_getter_record_4_fields.arl", {}, params);
        this.address = address;
...
export const type_getter_record_4_fields = new Type_getter_record_4_fields();
