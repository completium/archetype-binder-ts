...
export class Training_addnumber {
    ...
    async increment(quantity: att.Nat, params: Partial<ex.Parameters>): Promise<att.CallResult> {
...
export const training_addnumber = new Training_addnumber();
