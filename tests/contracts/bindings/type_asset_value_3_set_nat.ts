...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: ["%s"] }, { prim: "set", args: [{ prim: "nat", annots: [] }], annots: ["%v"] }], annots: [] }], annots: [] };
...
export class Type_asset_value_3_set_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_set_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_set_nat = new Type_asset_value_3_set_nat();
