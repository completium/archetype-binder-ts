...
export class Type_list_bls12_381_g2 {
    ...
    async set_value(i: Array<att.Bls12_381_g2>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
    ...
    async get_res(): Promise<Array<att.Bls12_381_g2>> {
        if (this.address != undefined) {
            ...
            return att.mich_to_list(storage, x => { return att.Bls12_381_g2.from_mich(x); });
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
