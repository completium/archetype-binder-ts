...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "option", args: [{ prim: "string", annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_option_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_list_option_string.arl", {}, params)).address;
        this.address = address;
    }
