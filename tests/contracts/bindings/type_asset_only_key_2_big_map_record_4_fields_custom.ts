...
export class Type_asset_only_key_2_big_map_record_4_fields_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_2_big_map_record_4_fields_custom.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_only_key_2_big_map_record_4_fields_custom = new Type_asset_only_key_2_big_map_record_4_fields_custom();
