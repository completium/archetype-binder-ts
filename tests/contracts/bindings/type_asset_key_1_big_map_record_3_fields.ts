...
export class r_record implements att.ArchetypeType {
    ...
    static from_mich(input: att.Micheline): r_record {
        return new r_record(att.mich_to_nat((input as att.Mpair).args[0]), att.mich_to_string((input as att.Mpair).args[1]), att.mich_to_bytes((input as att.Mpair).args[2]));
    }
}
...
export class Type_asset_key_1_big_map_record_3_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_1_big_map_record_3_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_1_big_map_record_3_fields = new Type_asset_key_1_big_map_record_3_fields();
