...
export class Type_asset_value_3_big_map_record_4_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_big_map_record_4_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_big_map_record_4_fields = new Type_asset_value_3_big_map_record_4_fields();
