...
export class my_asset_value implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.v.to_mich(), att.string_to_mich(this.v), this.v.to_mich()]);
    }
...
export class Type_asset_value_2_big_map_tuple_nat_string_bytes {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_big_map_tuple_nat_string_bytes.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        att.Nat,
...
export const type_asset_value_2_big_map_tuple_nat_string_bytes = new Type_asset_value_2_big_map_tuple_nat_string_bytes();
