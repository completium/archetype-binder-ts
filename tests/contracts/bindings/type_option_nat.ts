...
export class Type_option_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_option_nat = new Type_option_nat();
