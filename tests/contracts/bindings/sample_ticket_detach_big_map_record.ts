...
export class Sample_ticket_detach_big_map_record {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/sample_ticket_detach_big_map_record.arl", {}, params)).address;
        this.address = address;
    }
...
export const sample_ticket_detach_big_map_record = new Sample_ticket_detach_big_map_record();
