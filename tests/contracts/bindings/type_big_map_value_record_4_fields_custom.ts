...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "bytes", annots: ["%f_c"] }], annots: [] }, { prim: "bool", annots: ["%f_d"] }], annots: [] }], annots: [] }], annots: [] };
...
export class Type_big_map_value_record_4_fields_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_value_record_4_fields_custom.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_res_value(key: att.Nat): Promise<r_record | undefined> {
        if (this.address != undefined) {
            ...
            if (data != undefined) {
                return mich_to_r_record(data, collapsed);
            }
            else {
                return undefined;
            }
...
export const type_big_map_value_record_4_fields_custom = new Type_big_map_value_record_4_fields_custom();
