...
export class Type_asset_only_key_2_rational {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_2_rational.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_only_key_2_rational = new Type_asset_only_key_2_rational();
