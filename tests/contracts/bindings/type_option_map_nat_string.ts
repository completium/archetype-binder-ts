...
export const storage_type: att.MichelineType = { prim: "option", args: [{ prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }], annots: [] };
...
export class Type_option_map_nat_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_map_nat_string.arl", {}, params)).address;
        this.address = address;
    }
