...
export class Type_asset_key_2_big_map_option_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_big_map_option_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_big_map_option_bool = new Type_asset_key_2_big_map_option_bool();
