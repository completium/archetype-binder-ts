...
export class Type_map_value_record_4_fields_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_record_4_fields_custom.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_record_4_fields_custom = new Type_map_value_record_4_fields_custom();
