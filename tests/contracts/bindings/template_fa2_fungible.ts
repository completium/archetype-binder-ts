...
export class Template_fa2_fungible {
    ...
    async deploy(owner: att.Address, permits: att.Address, params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/template_fa2_fungible.arl", {
            owner: owner.to_mich(),
...
export const template_fa2_fungible = new Template_fa2_fungible();
