...
export class Type_simple_record_2_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_record_2_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_record_2_fields = new Type_simple_record_2_fields();
