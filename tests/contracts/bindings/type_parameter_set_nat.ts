...
export class Type_parameter_set_nat {
    ...
    async deploy(res: Array<att.Nat>, params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_parameter_set_nat.arl", {
    ...
    async asset_add(i: Array<att.Nat>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
...
export const type_parameter_set_nat = new Type_parameter_set_nat();
