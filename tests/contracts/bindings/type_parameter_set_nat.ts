...
export class Type_asset_parameter_set_nat {
    ...
    async deploy(res: Array<att.Nat>, params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_set_nat.arl", {
...
export const type_asset_parameter_set_nat = new Type_asset_parameter_set_nat();
