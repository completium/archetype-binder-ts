...
export const storage_type: att.MichelineType = { prim: "timestamp", annots: [] };
const set_value_arg_to_mich = (i: Date): att.Micheline => {
    return att.date_to_mich(i);
}
export class Type_simple_date {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_date.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_date = new Type_simple_date();
