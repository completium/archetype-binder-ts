...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "pair", args: [{ prim: "pair", args: [{ prim: "string", annots: ["%f_b"] }, { prim: "bytes", annots: ["%f_c"] }], annots: [] }, { prim: "bool", annots: ["%f_d"] }], annots: [] }], annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_map_key_record_4_fields_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_key_record_4_fields_custom.arl", {}, params)).address;
        this.address = address;
    }
