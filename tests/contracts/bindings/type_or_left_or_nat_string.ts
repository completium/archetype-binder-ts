...
export class Type_or_left_or_nat_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const res = await ex.deploy("./tests/contracts/type_or_left_or_nat_string.arl", {}, params);
    ...
    async get_res(): Promise<att.Or<att.Or<att.Nat, att.Nat>, att.Or<att.Nat, att.Nat>>> {
        if (this.address != undefined) {
            ...
            return (x => {
                ...
                return new att.Or<att.Or<att.Nat, att.Nat>, att.Or<att.Nat, att.Nat>>(value, is_left);
            })(storage);
        }
        throw new Error("Contract not initialised");
    }
