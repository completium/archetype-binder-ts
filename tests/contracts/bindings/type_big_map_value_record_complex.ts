...
export class Type_big_map_value_record_complex {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_value_record_complex.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_big_map_value_record_complex = new Type_big_map_value_record_complex();
