...
export class Type_or_left_enum_param {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_left_enum_param.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_or_left_enum_param = new Type_or_left_enum_param();
