...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "list", args: [{ prim: "string", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] }], annots: [] };
