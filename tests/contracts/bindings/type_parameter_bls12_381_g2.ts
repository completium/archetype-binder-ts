...
export class Type_asset_parameter_bls12_381_g2 {
    ...
    async deploy(res: att.Bls12_381_g2, params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_bls12_381_g2.arl", {
            res: res.to_mich()
        }, params);
        this.address = address;
    }
...
export const type_asset_parameter_bls12_381_g2 = new Type_asset_parameter_bls12_381_g2();
