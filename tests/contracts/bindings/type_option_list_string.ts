...
export const storage_type: att.MichelineType = { prim: "option", args: [{ prim: "list", args: [{ prim: "string", annots: [] }], annots: [] }], annots: [] };
...
export class Type_option_list_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_list_string.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: att.Option<Array<string>>, params: Partial<ex.Parameters>): Promise<any> {
...
export const type_option_list_string = new Type_option_list_string();
