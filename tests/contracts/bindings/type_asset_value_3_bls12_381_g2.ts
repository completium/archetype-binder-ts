...
export class Type_asset_value_3_bls12_381_g2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_bls12_381_g2.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_bls12_381_g2 = new Type_asset_value_3_bls12_381_g2();
