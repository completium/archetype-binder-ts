...
export class Type_simple_list_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_list_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_list_bool = new Type_simple_list_bool();
