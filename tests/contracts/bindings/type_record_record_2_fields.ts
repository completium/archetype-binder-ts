...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%n"] }, { prim: "pair", args: [{ prim: "pair", args: [{ prim: "nat", annots: ["%f_a"] }, { prim: "string", annots: ["%f_b"] }], annots: ["%v"] }, { prim: "string", annots: ["%s"] }], annots: [] }], annots: [] };
...
export class Type_record_record_2_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_record_record_2_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_record_record_2_fields = new Type_record_record_2_fields();
