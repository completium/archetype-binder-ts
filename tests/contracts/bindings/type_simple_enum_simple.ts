...
export class Type_simple_enum_simple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_simple_enum_simple.arl", {}, params);
        this.address = address;
    }
...
export const type_simple_enum_simple = new Type_simple_enum_simple();
