...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "nat", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] };
...
export class Type_asset_key_2_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_nat.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_nat = new Type_asset_key_2_nat();
