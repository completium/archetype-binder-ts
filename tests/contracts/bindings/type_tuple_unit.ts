...
export class Type_tuple_unit {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_tuple_unit.arl", {}, params);
        this.address = address;
    }
    ...
    async get_res(): Promise<[
        ...
        if (this.address != undefined) {
            ...
            return [(x => { return new att.Nat(x); })(storage[Object.keys(storage)[0]]), (x => { return new att.Unit(x); })(storage[Object.keys(storage)[1]]), (x => { return x; })(storage[Object.keys(storage)[2]])];
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
