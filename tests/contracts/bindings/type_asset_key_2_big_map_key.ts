...
export class Type_asset_key_2_big_map_key {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_big_map_key.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_key_2_big_map_key = new Type_asset_key_2_big_map_key();
