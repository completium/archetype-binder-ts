...
export class Type_asset_parameter_tuple_nat_string_bytes_rev {
    ...
    async deploy(res: [
        ...
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_tuple_nat_string_bytes_rev.arl", {
...
export const type_asset_parameter_tuple_nat_string_bytes_rev = new Type_asset_parameter_tuple_nat_string_bytes_rev();
