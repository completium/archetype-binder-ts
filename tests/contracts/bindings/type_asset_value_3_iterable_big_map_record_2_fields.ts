...
export class my_asset_value implements att.ArchetypeType {
    ...
    static from_mich(input: att.Micheline): my_asset_value {
        return new my_asset_value(att.mich_to_string((input as att.Mpair).args[0]), r_record.from_mich(att.pair_to_mich((input as att.Mpair as att.Mpair).args.slice(1, 3))));
    }
}
...
export class Type_asset_value_3_iterable_big_map_record_2_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_iterable_big_map_record_2_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_iterable_big_map_record_2_fields = new Type_asset_value_3_iterable_big_map_record_2_fields();
