...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "set", args: [{ prim: "bool", annots: [] }], annots: [] }, { prim: "string", annots: [] }], annots: [] }], annots: [] };
const set_value_arg_to_mich = (i: Array<boolean>): att.Micheline => {
    return att.list_to_mich(i, x => {
        return att.bool_to_mich(x);
    });
}
export class Type_tuple_set_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_tuple_set_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_tuple_set_bool = new Type_tuple_set_bool();
