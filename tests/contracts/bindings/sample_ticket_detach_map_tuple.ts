...
export class Sample_ticket_detach_map_tuple {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/sample_ticket_detach_map_tuple.arl", {}, params)).address;
        this.address = address;
    }
...
export const sample_ticket_detach_map_tuple = new Sample_ticket_detach_map_tuple();
