...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "mutez", annots: [] }], annots: [] };
const set_value_arg_to_mich = (i: att.Tez): att.Micheline => {
    return i.to_mich();
}
export class Type_map_value_tez {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_tez.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_tez = new Type_map_value_tez();
