...
export class my_asset_value implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.v[0].to_mich(), att.pair_to_mich([att.string_to_mich(this.v[1][0]), this.v[1][1].to_mich()]), att.bool_to_mich(this.v[2])]);
    }
...
export class Type_asset_value_2_big_map_record_4_fields_custom {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_big_map_record_4_fields_custom.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_2_big_map_record_4_fields_custom = new Type_asset_value_2_big_map_record_4_fields_custom();
