...
export class my_record implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.n.to_mich(), att.pair_to_mich([att.pair_to_mich([att.pair_to_mich([this.v[0][0][0].to_mich(), att.string_to_mich(this.v[0][0][1])]), this.v[0][1].to_mich()]), att.bool_to_mich(this.v[1])])]);
    }
