...
export class Type_asset_parameter_int {
    ...
    async deploy(res: att.Int, params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_asset_parameter_int.arl", {
            res: res.to_mich()
        }, params);
        this.address = address;
    }
...
export const type_asset_parameter_int = new Type_asset_parameter_int();
