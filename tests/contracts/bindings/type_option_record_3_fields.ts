...
export class Type_option_record_3_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_record_3_fields.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: att.Option<r_record>, params: Partial<ex.Parameters>): Promise<att.CallResult> {
...
export const type_option_record_3_fields = new Type_option_record_3_fields();
