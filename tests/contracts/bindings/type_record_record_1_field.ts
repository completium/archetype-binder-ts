...
export class Type_record_record_1_field {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_record_record_1_field.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_record_record_1_field = new Type_record_record_1_field();
