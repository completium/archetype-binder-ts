...
export class Type_asset_key_2_big_map_tuple_nat_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_key_2_big_map_tuple_nat_string.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        att.Nat,
...
export const type_asset_key_2_big_map_tuple_nat_string = new Type_asset_key_2_big_map_tuple_nat_string();
