...
export const storage_type: att.MichelineType = { prim: "set", args: [{ prim: "option", args: [{ prim: "string", annots: [] }], annots: [] }], annots: [] };
...
export class Type_set_option_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_set_option_string.arl", {}, params)).address;
        this.address = address;
    }
