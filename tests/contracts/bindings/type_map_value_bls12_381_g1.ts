...
export class Type_map_value_bls12_381_g1 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_map_value_bls12_381_g1.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_map_value_bls12_381_g1 = new Type_map_value_bls12_381_g1();
