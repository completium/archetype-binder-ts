...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "nat", annots: [] }, { prim: "option", args: [{ prim: "bool", annots: [] }], annots: [] }], annots: [] };
const set_value_arg_to_mich = (i: att.Option<boolean>): att.Micheline => {
    return i.to_mich((x => { return att.bool_to_mich(x); }));
}
export class Type_big_map_value_option_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_value_option_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_big_map_value_option_bool = new Type_big_map_value_option_bool();
