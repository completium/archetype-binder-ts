...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%n"] }, { prim: "pair", args: [{ prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: ["%v"] }, { prim: "string", annots: ["%s"] }], annots: [] }], annots: [] };
