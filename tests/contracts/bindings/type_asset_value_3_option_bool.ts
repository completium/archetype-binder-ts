...
export const storage_type: att.MichelineType = { prim: "map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: ["%s"] }, { prim: "option", args: [{ prim: "bool", annots: [] }], annots: ["%v"] }], annots: [] }], annots: [] };
