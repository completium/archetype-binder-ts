...
export class my_asset_value implements att.ArchetypeType {
    constructor(public v: e_enum) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return this.v.to_mich((x => { return att.unit_to_mich(); }), (x => { return x.to_mich((x => { return x.to_mich(); }), (x => { return x.to_mich((x => { return att.string_to_mich(x); }), (x => { return att.pair_to_mich([x[0].to_mich(), att.bool_to_mich(x[1])]); })); })); }));
    }
    equals(v: my_asset_value): boolean {
        return this.v == v.v;
    }
    static from_mich(input: att.Micheline): my_asset_value {
        return new my_asset_value(mich_to_e_enum(input));
    }
}
export const my_asset_value_mich_type: att.MichelineType = att.or_to_mich_type(att.prim_annot_to_mich_type("unit", ["%e_1"]), att.or_to_mich_type(att.prim_annot_to_mich_type("nat", ["%e_2"]), att.or_to_mich_type(att.prim_annot_to_mich_type("string", ["%e_3"]), att.pair_array_to_mich_type([
...
export const my_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("big_map", att.prim_annot_to_mich_type("nat", []), att.or_to_mich_type(att.prim_annot_to_mich_type("unit", ["%e_1"]), att.or_to_mich_type(att.prim_annot_to_mich_type("nat", ["%e_2"]), att.or_to_mich_type(att.prim_annot_to_mich_type("string", ["%e_3"]), att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("bytes", []),
    att.prim_annot_to_mich_type("bool", [])
], ["%e_4"]), []), []), []), []);
...
export class Type_asset_value_2_big_map_enum_param {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_big_map_enum_param.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_2_big_map_enum_param = new Type_asset_value_2_big_map_enum_param();
