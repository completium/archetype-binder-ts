...
export class Type_asset_value_3_sapling_transaction {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_sapling_transaction.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_sapling_transaction = new Type_asset_value_3_sapling_transaction();
