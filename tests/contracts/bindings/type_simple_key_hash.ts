...
export class Type_simple_key_hash {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_key_hash.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_key_hash = new Type_simple_key_hash();
