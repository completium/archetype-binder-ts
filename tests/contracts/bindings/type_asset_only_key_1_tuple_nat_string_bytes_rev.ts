...
export class Type_asset_only_key_1_tuple_nat_string_bytes_rev {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_1_tuple_nat_string_bytes_rev.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        [
...
export const type_asset_only_key_1_tuple_nat_string_bytes_rev = new Type_asset_only_key_1_tuple_nat_string_bytes_rev();
