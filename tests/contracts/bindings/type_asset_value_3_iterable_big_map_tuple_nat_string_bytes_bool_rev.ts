...
export class Type_asset_value_3_iterable_big_map_tuple_nat_string_bytes_bool_rev {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_iterable_big_map_tuple_nat_string_bytes_bool_rev.arl", {}, params)).address;
        this.address = address;
    }
    async asset_put(i: [
        [
...
export const type_asset_value_3_iterable_big_map_tuple_nat_string_bytes_bool_rev = new Type_asset_value_3_iterable_big_map_tuple_nat_string_bytes_bool_rev();
