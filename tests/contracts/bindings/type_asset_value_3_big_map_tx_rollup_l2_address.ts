...
export class Type_asset_value_3_big_map_tx_rollup_l2_address {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_3_big_map_tx_rollup_l2_address.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_3_big_map_tx_rollup_l2_address = new Type_asset_value_3_big_map_tx_rollup_l2_address();
