...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "signature", annots: [] }, { prim: "nat", annots: [] }], annots: [] };
...
export class Type_or_left_signature {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_left_signature.arl", {}, params)).address;
        this.address = address;
    }
