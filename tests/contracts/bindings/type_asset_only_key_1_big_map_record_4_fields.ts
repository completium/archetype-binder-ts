...
export class my_asset_key implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.k[0].to_mich(), att.string_to_mich(this.k[1]), this.k[2].to_mich(), att.bool_to_mich(this.k[3])]);
    }
...
export class Type_asset_only_key_1_big_map_record_4_fields {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_only_key_1_big_map_record_4_fields.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_only_key_1_big_map_record_4_fields = new Type_asset_only_key_1_big_map_record_4_fields();
