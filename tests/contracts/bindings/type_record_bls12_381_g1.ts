...
export const storage_type: att.MichelineType = { prim: "pair", args: [{ prim: "nat", annots: ["%n"] }, { prim: "pair", args: [{ prim: "bls12_381_g1", annots: ["%v"] }, { prim: "string", annots: ["%s"] }], annots: [] }], annots: [] };
