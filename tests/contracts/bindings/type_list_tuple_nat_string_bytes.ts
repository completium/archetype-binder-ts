...
export const storage_type: att.MichelineType = { prim: "list", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: [] }, { prim: "bytes", annots: [] }], annots: [] }], annots: [] }], annots: [] };
...
export class Type_list_tuple_nat_string_bytes {
...
export const type_list_tuple_nat_string_bytes = new Type_list_tuple_nat_string_bytes();
