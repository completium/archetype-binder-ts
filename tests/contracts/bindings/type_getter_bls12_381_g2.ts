...
export class Type_getter_bls12_381_g2 {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_getter_bls12_381_g2.arl", {}, params);
        this.address = address;
    ...
    async get_value(i: att.Bls12_381_g2, params: Partial<ex.Parameters>): Promise<att.Bls12_381_g2> {
        if (this.address != undefined) {
            if (this.get_value_callback_address != undefined) {
                ...
                return await ex.get_callback_value<att.Bls12_381_g2>(this.get_value_callback_address, x => { return new att.Bls12_381_g2(x); });
            }
        }
        throw new Error("Contract not initialised");
    }
    async get_res(): Promise<att.Bls12_381_g2> {
        if (this.address != undefined) {
            ...
            return new att.Bls12_381_g2(storage);
        }
        throw new Error("Contract not initialised");
    }
    errors = {};
}
export const type_getter_bls12_381_g2 = new Type_getter_bls12_381_g2();
