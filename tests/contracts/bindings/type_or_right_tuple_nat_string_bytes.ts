...
export const storage_type: att.MichelineType = { prim: "or", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "string", annots: [] }, { prim: "bytes", annots: [] }], annots: [] }], annots: [] }], annots: [] };
...
export class Type_or_right_tuple_nat_string_bytes {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_or_right_tuple_nat_string_bytes.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: [
        att.Nat,
