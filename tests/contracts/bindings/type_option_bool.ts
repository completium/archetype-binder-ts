...
export class Type_option_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_option_bool = new Type_option_bool();
