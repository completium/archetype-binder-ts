...
export class Type_record_set_string {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = await ex.deploy("./tests/contracts/type_record_set_string.arl", {}, params);
        this.address = address;
    }
...
export const type_record_set_string = new Type_record_set_string();
