...
export class Type_simple_duration {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_simple_duration.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_simple_duration = new Type_simple_duration();
