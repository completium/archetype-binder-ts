...
export class Type_asset_value_2_big_map_int {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_big_map_int.arl", {}, params)).address;
        this.address = address;
    }
    ...
    async get_my_asset_value(key: att.Nat): Promise<att.Int | undefined> {
        if (this.address != undefined) {
...
export const type_asset_value_2_big_map_int = new Type_asset_value_2_big_map_int();
