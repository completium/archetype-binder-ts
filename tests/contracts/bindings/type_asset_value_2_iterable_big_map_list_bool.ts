...
export const my_asset_container_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.pair_annot_to_mich_type("big_map", att.prim_annot_to_mich_type("nat", []), att.pair_array_to_mich_type([
        ...
        att.list_annot_to_mich_type(att.prim_annot_to_mich_type("bool", []), ["%value"])
    ], ["%values"]), ["%values"]),
...
export class Type_asset_value_2_iterable_big_map_list_bool {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_asset_value_2_iterable_big_map_list_bool.arl", {}, params)).address;
        this.address = address;
    }
...
export const type_asset_value_2_iterable_big_map_list_bool = new Type_asset_value_2_iterable_big_map_list_bool();
