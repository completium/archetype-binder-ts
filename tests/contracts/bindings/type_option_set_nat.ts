...
export const storage_type: att.MichelineType = { prim: "option", args: [{ prim: "set", args: [{ prim: "nat", annots: [] }], annots: [] }], annots: [] };
...
export class Type_option_set_nat {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_option_set_nat.arl", {}, params)).address;
        this.address = address;
    }
