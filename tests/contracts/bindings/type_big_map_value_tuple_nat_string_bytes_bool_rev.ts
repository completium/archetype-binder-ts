...
export const storage_type: att.MichelineType = { prim: "big_map", args: [{ prim: "nat", annots: [] }, { prim: "pair", args: [{ prim: "pair", args: [{ prim: "pair", args: [{ prim: "nat", annots: [] }, { prim: "string", annots: [] }], annots: [] }, { prim: "bytes", annots: [] }], annots: [] }, { prim: "bool", annots: [] }], annots: [] }], annots: [] };
...
export class Type_big_map_value_tuple_nat_string_bytes_bool_rev {
    ...
    async deploy(params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./tests/contracts/type_big_map_value_tuple_nat_string_bytes_bool_rev.arl", {}, params)).address;
        this.address = address;
    }
    async set_value(i: [
        [
...
export const type_big_map_value_tuple_nat_string_bytes_bool_rev = new Type_big_map_value_tuple_nat_string_bytes_bool_rev();
