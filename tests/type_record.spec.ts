...
import * as type_record_tx_rollup_l2_address from './contracts/bindings/type_record_tx_rollup_l2_address'
...
import * as type_record_enum_param from './contracts/bindings/type_record_enum_param'
import * as type_record_record_1_field from './contracts/bindings/type_record_record_1_field'
...
import * as type_record_record_complex from './contracts/bindings/type_record_record_complex'
...
describe('Type record', () => {
  ...
  // signature
  it('signature', async () => {
    const v : type_record_signature.my_record = new type_record_signature.my_record(new Nat(2), new Signature("sigPGRuva6xjBJkmb6BYpbovGb4BoobkE3GUN2njdxwkG25yRT39GaDrsBgczf5VybSRGi5eddQy6VBfUkg2YcLfMvgg8Uk1"), "mystr");
  ...
  it('tx_rollup_l2_address', async () => {
    const v : type_record_tx_rollup_l2_address.my_record = new type_record_tx_rollup_l2_address.my_record(new Nat(2), new Tx_rollup_l2_address("tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm"), "mystr");
    await type_record_tx_rollup_l2_address.type_record_tx_rollup_l2_address.deploy({ as: alice });
    await type_record_tx_rollup_l2_address.type_record_tx_rollup_l2_address.set_value(v, { as: alice });
    const res = await type_record_tx_rollup_l2_address.type_record_tx_rollup_l2_address.get_res();
    assert(v.equals(res), "Invalid Value")
  });
  ...
  // enum_param
  it('enum_param', async () => {
    const v : type_record_enum_param.my_record = new type_record_enum_param.my_record(new Nat(2), new type_record_enum_param.e_2(new Nat(2)), "mystr");
    await type_record_enum_param.type_record_enum_param.deploy({ as: alice });
    await type_record_enum_param.type_record_enum_param.set_value(v, { as: alice });
    const res = await type_record_enum_param.type_record_enum_param.get_res();
    assert(v.equals(res), "Invalid Value")
  });
