...
describe('Type asset_key_1', () => {
  ...
  it('enum_simple', async () => {
    ...
    assert(1 == res.length && ((x : type_asset_key_1_enum_simple.e_enum, y : type_asset_key_1_enum_simple.e_enum) => {return x.toString() == y.toString()})(v, res[0][0]), "Invalid Value")
  });
  ...
  it('enum_param', async () => {
    ...
    assert(1 == res.length && ((x : type_asset_key_1_enum_param.e_enum, y : type_asset_key_1_enum_param.e_enum) => {return x.toString() == y.toString()})(v, res[0][0]), "Invalid Value")
  });
